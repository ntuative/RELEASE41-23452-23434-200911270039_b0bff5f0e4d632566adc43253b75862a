package
{
   ...
   public class HabboMain extends Sprite implements IHabboMain
   {
      ...
      private var var_871:ICore;
      
      private var var_1513:ICoreConfigStatusListener;
      ...
      public function initializeCore() : void
      {
         ...
         {
            Core.crash("Failed to initialize the core: " + error.message,CoreComponent.const_1094,error);
         }
      }
      ...
      {
         initCore("config_habbo.xml",Core.const_772);
      }
      ...
      private function prepareBakedInComponent(param1:Class) : void
      {
         ...
         var_871.prepareComponent(manifest,resource);
      }
      ...
      private function initCore(param1:String, param2:uint) : void
      {
         ...
         var_871 = Core.instantiate(this,param2);
         initBakedInComponents();
         var_871.events.addEventListener(Component.COMPONENT_EVENT_ERROR,onCoreError);
         var_871.loadExternalConfigDocument(new URLRequest(param1),var_1513);
      }
   }
}
