package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_945:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_531:uint = 0;
      
      public static const const_1113:String = "AssetLibraryReady";
      
      public static const const_1207:String = "AssetLibraryUnloaded";
      
      public static const const_449:String = "AssetLibraryLoaded";
      
      public static const const_1175:String = "AssetLibraryLoadError";
       
      
      private var var_457:XML;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         var_384 = new Dictionary(false);
         var_631 = new Dictionary(false);
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_384)
         {
            _loc2_ = var_384[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_384[_loc1_];
         }
         for(_loc1_ in _loadedAssets)
         {
            delete _loadedAssets[_loc1_];
         }
         for(_loc1_ in var_631)
         {
         ...
         var_285 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1207));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_457 = _loc2_.manifest.copy();
         var_326 = _loc2_.resource;
         if(var_458)
         {
            AssetLibrary.fetchLibraryContents(this,var_457,var_326);
         }
         var_285 = true;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_384[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_900,assetLoadEventHandler);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_945.splice(var_945.indexOf(this),1);
            --var_531;
            var_384 = null;
            var_631 = null;
            _loadedAssets = null;
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1175));
      }
      ...
      {
         var _loc2_:Class = var_631[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         if(_file == param1.url && var_285)
         {
            ...
            var_458 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1113));
         }
         else
         {
            if(var_1 == null)
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_457.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_326[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_384[loader.url];
         if(struct == null)
         {
      ...
      {
         return var_326 != null ? false : false;
      }
   }
}
