package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1033:LoaderContext;
      
      protected var var_44:Array;
      
      protected var var_492:Array;
      
      private var var_582:uint = 0;
      
      protected var var_350:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_44 = new Array();
         var_492 = new Array();
         var_1033 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_350 = new AssetLibrary("lib-" + var_582++);
         var_44.push(var_350);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return var_350.createAsset(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_350.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function unload() : void
      {
         while(false)
         {
            (var_492.pop() as IAssetLibrary).dispose();
         }
         while(false)
         {
      ...
      {
         return var_350.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      {
         return var_350.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return var_350.setAsset(param1,param2,param3);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_350.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = false, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         var _loc4_:IAssetLibrary = new AssetLibrary("lib-" + var_582++);
         var_492.push(_loc4_);
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         {
            _loc4_ = 0;
            while(_loc4_ < var_492.length)
            {
               _loc3_ = var_492[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  var_492.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
      ...
      {
         return var_350.loadFromResource(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_350.getAssetTypeDeclarationByMimeType(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      {
         return var_350.loadFromArchive(param1,param2);
      }
