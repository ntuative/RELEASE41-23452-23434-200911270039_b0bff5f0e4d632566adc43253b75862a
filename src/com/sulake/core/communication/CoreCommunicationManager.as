package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, ICoreUpdateReceiver
   {
      ...
      private var var_2089:IConnectionStateListener;
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         for(_loc4_ in var_485)
         {
            _loc10_;
            if(var_485[_loc4_] == param1)
            {
               _loc3_ = _loc4_;
               break;
            }
         ...
         var _loc5_:Array = var_691[_loc3_];
      ...
      {
         var _loc3_:Array = var_691[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            var_691[param1] = _loc3_;
         }
         _loc3_.push(param2);
      }
      ...
      {
         return var_485[param1] as IConnection;
      }
      ...
      {
         var _loc2_:Class = var_690[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         for each(var _loc5_ in var_485)
         {
            _loc2_ = _loc5_;
            _loc5_;
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_943:
               _loc3_ = new SocketConnection(param1,this,var_2089);
               break;
            default:
               Logger.log("[CoreCommunicationManager] Unknown connectionType, can not create connection: " + param2);
         }
         var_485[param1] = _loc3_;
         return _loc3_;
      }
