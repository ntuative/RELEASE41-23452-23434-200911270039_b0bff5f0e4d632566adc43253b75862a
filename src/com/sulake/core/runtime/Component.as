package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1142:uint = 4;
      ...
      protected var var_370:uint = 0;
      
      protected var _context:IContext = null;
      
      protected var var_2031:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_869 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_869);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1034 & const_1142)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_370 + "]";
      }
   }
}
