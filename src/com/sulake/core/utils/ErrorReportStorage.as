package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_1082:Map = new Map();
      
      private static var var_728:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         ...
         while(_loc2_ < var_728.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_728.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_728.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
