package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1342:uint = 2;
      
      protected static const const_1340:uint = 1;
      
      protected static const const_1339:int = 5;
      
      protected static const const_1046:uint = 7;
      
      protected static const const_1341:uint = 4;
      
      protected static const const_1343:uint = 3;
       
      
      protected var var_867:int;
      
      protected var var_2139:String = "";
      
      protected var var_352:int;
      
      protected var var_457:XML;
      
      protected var var_1287:Boolean = false;
      ...
      protected var var_305:URLRequest;
      
      protected var var_868:Boolean = false;
      
      protected var _name:String;
      
      protected var var_326:Class;
      ...
      {
         var_2140 = param1;
         dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,var_352));
      }
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_326 = this.getDefinition(_name) as Class;
         if(var_326 == null)
         {
            failure("Failed to find resource class \"" + _name + "\" in library " + var_305.url + "!");
            return;
         }
         try
         {
            xmlClass = var_326.manifest as Class;
            if(xmlClass == null)
            {
               return;
            }
         ...
         var_457 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function debug(param1:String) : void
      {
         ...
         if(var_868)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DEBUG,var_352));
         }
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               ...
               debug("Load event STATUS " + var_352 + " for file \"" + var_1.contentLoaderInfo.url + "\"");
               break;
            case Event.UNLOAD:
               debug("Load event UNLOAD for file \"" + var_1.contentLoaderInfo.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_UNLOAD,var_352));
               break;
            case ProgressEvent.PROGRESS:
               debug("Load event PROGRESS for file \"" + var_1.contentLoaderInfo.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_PROGRESS,var_352));
               break;
            case IOErrorEvent.IO_ERROR:
               failure("IO Error, send or load operation failed for file \"" + var_1.contentLoaderInfo.url + "\"");
               if(!handleHttpStatus(var_352))
               {
         ...
         if(var_415 == LibraryLoader.const_1343)
         {
            if(analyzeLibrary())
            {
               var_415 |= 0;
         ...
         if(var_415 == LibraryLoader.const_1046)
         {
            var_1287 = true;
            prepareLibrary();
            removeEventListeners();
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,var_352));
         }
      }
      ...
      protected function handleHttpStatus(param1:int) : Boolean
      {
         if(param1 >= 400)
         {
            if(var_867 > 0)
            {
               var_1.close();
               var_1.unload();
               addRequestCounterToUrlRequest(var_305,const_1339 - var_867);
               var_1.load(var_305,_context);
               --var_867;
               return true;
            }
