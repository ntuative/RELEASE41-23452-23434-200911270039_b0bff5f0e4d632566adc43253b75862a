package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IChildEntity, IGraphicContextHost
   {
         ...
         if(_loc9_)
         {
            ...
            if(param2)
            {
               ...
               while(_loc3_ < _loc10_)
               {
                  ...
                  _loc13_ = param1.testParamFlag(WindowParam.const_76);
                  if(_loc13_)
                  {
                     param1.setParamFlag(WindowParam.const_76,false);
                  }
                  param1.offset(-_loc4_,-_loc5_);
                  if(_loc13_)
                  {
                     param1.setParamFlag(WindowParam.const_76,true);
                  }
                  _loc3_++;
               }
            }
      ...
      public function method_14(param1:uint) : Boolean
      {
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_114,WindowParam.const_140);
         var _loc2_:* = !testParamFlag(WindowParam.const_110,WindowParam.const_148);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_22.clone();
            if(_loc1_)
         ...
         else if(testParamFlag(WindowParam.const_76))
         {
            _loc3_ = var_22.clone();
            if(var_23 != null)
            {
      ...
      {
         if(_state == WindowState.const_430)
         {
            return true;
         }
         _state = WindowState.const_430;
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_904,this,null);
         update(this,_loc1_);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1950 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1238:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1259:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_884:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_768:
               _loc2_ = "null";
               break;
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_87 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_404,this,null));
         }
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_22,WindowRedrawFlag.const_818);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_978 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_319,this,param1));
         return param1;
      }
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_496);
      }
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_770;
                  if(testParamFlag(WindowParam.const_275))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_184))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_184))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_223:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_426,this,null));
                     if(testParamFlag(WindowParam.const_153,WindowParam.const_140))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_167,WindowParam.const_148))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_23 != null)
                     {
                        ...
                        var_30 = _loc8_;
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_265,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_416:
                  _context.invalidate(this,var_22.union(var_60),WindowRedrawFlag.const_415);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_898,this,null));
                     if(var_23 != null)
                     {
               ...
               case WindowNotifyEvent.const_324:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_669,this,null));
                     if(var_23 != null)
                     {
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_211,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_462:
                  _context.invalidate(this,var_22,WindowRedrawFlag.const_769);
                  break;
               case WindowNotifyEvent.const_404:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_439:
                  if(!(var_30 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_22,WindowRedrawFlag.const_415);
                     }
                  }
                  else if(var_30 & 0)
                  {
               ...
               case WindowNotifyEvent.const_211:
                  ...
                  break;
               case WindowNotifyEvent.const_426:
                  var_23.getRegionProperties(null,var_291);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_319:
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_768;
         update(this,_loc1_);
         return true;
      }
      ...
      public function maximize() : Boolean
      {
         ...
         setStateFlag(WindowState.const_57,true);
         _loc1_.type = WindowNotifyEvent.const_839;
         update(this,_loc1_);
         return true;
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_496);
      }
      ...
      {
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_788,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         if(_children.removeChild(_loc2_) != null)
         {
            ...
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_678,this,param1));
            return param1;
         }
         return null;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_499;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_978 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            _loc7_ = uint(var_30 & 0);
            if(_loc7_ == WindowParam.const_387)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_370)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         }
         if(testParamFlag(WindowParam.const_76))
         {
            if(var_23 != null)
            {
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_690,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
         ...
         if(var_306 && var_496 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_22.width && param1.y <= var_22.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1429,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1429,param3,param1)) : false;
            }
         }
      ...
      public function expandToAccommodateChildren() : void
      {
         ...
         var _loc9_:Boolean = getParamFlag(WindowParam.const_60);
         _loc1_ = 0;
         while(_loc1_ < _loc8_)
         {
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_23 != param1)
         {
            ...
            if(var_23 != null)
            {
               var_291 = var_23.rectangle.clone();
               var_60.x = var_22.x;
               var_60.y = var_22.y;
               var_60.width = var_22.width;
               var_60.height = var_22.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_436,this,var_23));
            }
            else
            {
               var_291.x = 0;
               ...
               var_291.width = 0;
               var_291.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_809,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,var_237,_type,var_87,var_30,_context,var_22,null,var_578,properties,var_576.concat(),_id) as WindowController;
         _loc2_.var_496 = var_496;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_571;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_591;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         var_496 = param1 > 255 ? 255 : uint(param1);
      }
