package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("handle_bitmap_disposing",var_417,PropertyStruct.const_58,var_417 != true));
         _loc1_.push(new PropertyStruct("bitmap_asset_name",var_1038,PropertyStruct.const_241,var_1038 != null));
         return _loc1_;
      }
