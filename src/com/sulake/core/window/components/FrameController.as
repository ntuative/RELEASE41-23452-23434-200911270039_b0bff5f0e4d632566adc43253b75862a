package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1009:String = "_TITLE";
      
      private static const const_1010:String = "_CONTENT";
      
      private static const const_1011:String = "_HEADER";
      
      private static const const_1008:String = "_SCALER";
      ...
      private var var_1074:IHeaderWindow;
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_181);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_209);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_181,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_181,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1074 == null)
         {
            var_1074 = findChildByTag(const_1011) as IHeaderWindow;
            if(!var_1074)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1009) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1008) as IScalerWindow;
      }
      ...
      {
         return content != null && var_1287 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_33 == null)
         {
            var_33 = findChildByTag(const_1010) as IWindowContainer;
            if(!var_33)
            {
