package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      public function InteractiveController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         param5 |= 0;
         var_418 = new Array();
         var_418[0] = MouseCursorType.const_292;
         var_418[1] = MouseCursorType.const_39;
         var_418[2] = MouseCursorType.const_292;
         var_418[3] = MouseCursorType.const_292;
         var_418[4] = MouseCursorType.const_39;
         var_418[5] = MouseCursorType.const_39;
         var_418[6] = MouseCursorType.const_292;
         if(var_308 == null)
         {
            var_308 = new Array();
            var_308[0] = WindowState.const_84;
            var_308[1] = WindowState.const_71;
            var_308[2] = WindowState.WINDOW_STATE_HOVERING;
            var_308[3] = WindowState.const_57;
