package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected var var_2211:Number = 0;
      
      protected var var_493:Boolean = false;
      
      protected var var_2210:Number = 0;
      ...
      protected var var_696:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function = null, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         ...
         var_73 = 0;
         param5 |= 0;
         _horizontal = param3 == WindowType.const_291;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12);
         var _loc13_:Rectangle = new Rectangle(0,0,width,height);
         _container = _context.create("_CONTAINER","",WindowType.const_313,WindowStyle.const_243,0 | 0 | 0 | 0,_loc13_,null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         _container.addEventListener(WindowEvent.const_43,containerEventHandler);
         _container.addEventListener(WindowEvent.const_464,containerEventHandler);
         _container.addEventListener(WindowEvent.const_290,containerEventHandler);
         _container.addEventListener(WindowEvent.const_382,containerEventHandler);
      ...
      {
         return new Rectangle(var_495 * maxScrollH,var_494 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_464,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_290,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_382,containerEventHandler);
         super.dispose();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("spacing",_spacing,PropertyStruct.const_86,_spacing != 0));
         _loc1_.push(new PropertyStruct("auto_arrange_items",var_696,PropertyStruct.const_58,var_696 != true));
         _loc1_.push(new PropertyStruct("scale_to_fit_items",var_493,PropertyStruct.const_58,var_493 != false));
         _loc1_.push(new PropertyStruct("resize_on_item_update",var_1037,PropertyStruct.const_58,var_1037 != false));
         return _loc1_;
      }
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            switch(_loc3_.key)
            {
               ...
               case "auto_arrange_items":
                  var_696 = _loc3_.value as Boolean;
                  break;
            }
            _loc4_++;
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_394,param1);
            }
            else
            {
