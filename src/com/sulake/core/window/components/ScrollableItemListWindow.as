   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_344)
         {
            ...
            if(var_344)
            {
               var_344.addEventListener(WindowEvent.const_236,scrollBarEventProc);
               var_344.addEventListener(WindowEvent.const_218,scrollBarEventProc);
            }
         }
         return var_344;
      }
      ...
      override public function dispose() : void
      {
         if(var_344)
         {
            var_344.removeEventListener(WindowEvent.const_236,scrollBarEventProc);
            var_344.removeEventListener(WindowEvent.const_218,scrollBarEventProc);
            var_344 = null;
         }
         if(_cachedItemList)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_218)
         {
            hideScrollBar();
         }
      }
