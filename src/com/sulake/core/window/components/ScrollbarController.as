package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1069:String = "increment";
      
      private static const const_481:String = "slider_bar";
      
      private static const const_1068:String = "decrement";
      ...
      protected var var_1510:Number = 0.1;
      ...
      {
         return track.getChildByName(ScrollbarController.const_481) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_787 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_787 != null)
         {
            _loc1_ = findParentByName(var_787) as IScrollableWindow;
            if(_loc1_ == null && var_23 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_23).findChildByName(var_787) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1069)
            {
               if(var_35)
               {
                  var_532 = true;
            ...
            else if(param2.name == ScrollbarController.const_1068)
            {
               if(var_35)
               {
                  var_532 = true;
         ...
         if(param1.type == WindowMouseEvent.const_976)
         {
