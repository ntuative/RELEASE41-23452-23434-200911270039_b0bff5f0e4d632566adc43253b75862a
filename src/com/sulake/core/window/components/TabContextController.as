package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_989:String = "content";
      
      private static const const_990:String = "selector";
       
      
      private var var_1166:Boolean = false;
      
      protected var var_857:ITabSelectorWindow;
      
      private var var_773:Boolean = false;
      
      protected var var_1506:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1506 == null)
         {
            var_1506 = findChildByTag(TabContextController.const_989) as IWindowContainer;
         }
         return var_1506;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_857 == null)
         {
            var_857 = findChildByTag(TabContextController.const_990) as ITabSelectorWindow;
            if(var_857 != null)
            {
               var_857.procedure = selectorEventProc;
            }
         }
         return var_857;
      }
