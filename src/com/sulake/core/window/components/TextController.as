package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2212:Rectangle = new Rectangle();
      ...
      {
         return new Rectangle(var_579 * maxScrollH,var_353 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_697)
         {
            context.removeLocalizationListener(var_237,this);
         }
         if(var_74 != null)
         {
            var_74.dispose();
      ...
      public function set text(param1:String) : void
      {
         ...
         var_237 = param1;
         if(var_237.charAt(0) == "$" && var_237.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_237.slice(2,var_237.indexOf("}")),this);
            var_697 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_face",defaultTextFormat.font,PropertyStruct.const_241,true));
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_1324,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_428,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.const_241,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_428,true));
         ...
         _loc1_.push(new PropertyStruct("grid_fit_type",_field.gridFitType,PropertyStruct.const_241,true));
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_86,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_491,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.const_241,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_491,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_58,true));
         _loc1_.push(new PropertyStruct("margin_left",var_74.left,PropertyStruct.const_86,true));
         _loc1_.push(new PropertyStruct("margin_top",var_74.top,PropertyStruct.const_86,true));
         _loc1_.push(new PropertyStruct("margin_right",var_74.right,PropertyStruct.const_86,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_74.bottom,PropertyStruct.const_86,true));
         _loc1_.push(new PropertyStruct("auto_size",var_497,PropertyStruct.const_241,var_497 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_491,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
