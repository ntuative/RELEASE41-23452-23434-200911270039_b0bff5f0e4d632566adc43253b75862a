package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1404:uint = 128;
      
      public static const const_1398:uint = 64;
      ...
      protected var var_1511:Boolean;
         ...
         if(var_577)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1511,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1511,16777215);
                  }
                  var_354 += bitmap.width * bitmap.height * 4;
               }
