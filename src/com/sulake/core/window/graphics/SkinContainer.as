package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1466 = new Dictionary();
         var_2014 = new Dictionary();
         TypeCodeTable.fillTables(var_1466,var_2014);
         var_1231 = new Dictionary();
         var_2013 = new Dictionary();
         StateCodeTable.fillTables(var_1231,var_2013);
         var_481 = new Dictionary();
         var_481["skin"] = BitmapSkinRenderer;
         var_481["bitmap"] = BitmapDataRenderer;
         var_481["fill"] = FillSkinRenderer;
         var_481["text"] = TextSkinRenderer;
         var_481["shape"] = ShapeSkinRenderer;
         var_481["unknown"] = SkinRenderer;
         var_481["FurnitureCreditLogic"] = NullSkinRenderer;
         if(var_355 == null)
         {
            var_355 = new Array();
            var_355.push(WindowState.const_57);
            var_355.push(WindowState.const_66);
            var_355.push(WindowState.const_83);
            var_355.push(WindowState.const_48);
            var_355.push(WindowState.WINDOW_STATE_HOVERING);
            var_355.push(WindowState.const_71);
            var_355.push(WindowState.const_84);
            var_355.push(WindowState.const_80);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1231)
         {
            _loc3_.push(var_1231[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1466[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_556[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_556[param1] = new Array(SkinContainer.const_1089);
         }
         var_556[param1][param2] = param3;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinRenderer(var_556[_loc1_]).dispose();
