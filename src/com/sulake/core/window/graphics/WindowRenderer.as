package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1435:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_546 = new Array();
         var_1436 = new Point();
         var_1435 = new Rectangle();
         var_292 = new Rectangle();
         var_293 = new Dictionary(true);
         var_679 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_293[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            if(!_loc1_.disposed)
            {
               ...
               var_292.x = _loc3_.dirty.x;
               var_292.y = _loc3_.dirty.y;
               var_292.width = _loc3_.dirty.width;
               var_292.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_292);
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_714,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_293[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete var_293[param1];
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            _disposed = true;
            var_546 = null;
            for(_loc1_ in var_293)
            {
               delete var_293[_loc1_];
            }
            var_293 = null;
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1436,var_1435))
            {
               if(param2.render(param1,var_1436,var_1435))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_679);
            var_293[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_714,windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_292.x = param2.x - param1.x;
            var_292.y = param2.y - param1.y;
            var_292.width = param2.width;
            var_292.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_32))
            {
               while(param1.testParamFlag(WindowParam.const_32))
               {
                  ...
                  var_292.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_292,WindowRedrawFlag.const_224);
