package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_761:uint = 1;
      
      private static const const_760:uint = 2;
       
      
      private var var_679:ISkinContainer;
      
      private var _drawBufferAllocator:DrawBufferAllocator;
      
      private var _disposed:Boolean;
      
      private var var_234:Rectangle;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_415:
               ...
               break;
            case WindowRedrawFlag.const_769:
               var_680 = var_679.getTheActualState(param1.type,param1.style,param1.state);
               if(var_680 != var_1007)
               {
                  var_235 = true;
                  _loc4_ = true;
               ...
               break;
            case WindowRedrawFlag.const_818:
               if(param1.testParamFlag(WindowParam.const_32))
               {
                  var_235 = true;
                  _loc4_ = true;
         ...
         if(_loc4_)
         {
            var_234.left = Math.min(var_234.left,param2.left);
            var_234.top = Math.min(var_234.top,param2.top);
            var_234.right = Math.max(var_234.right,param2.right);
            var_234.bottom = Math.max(var_234.bottom,param2.bottom);
         }
         return _loc4_;
      }
      ...
      {
         return var_679.getTheActualState(param1.type,param1.style,param1.state) != var_1007;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc10_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_760) : uint(const_488);
         var _loc6_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc6_ != null)
         {
            _loc5_ = !!_loc6_.isStateDrawable(var_680) ? uint(const_761) : uint(_loc5_);
         }
         ...
         if(_loc5_ != const_488)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_761)
               {
                  ...
                  if(var_235)
                  {
                     ...
                     _loc6_.draw(param1,var_99,var_99.rect,var_680,false);
                  ...
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_32))
                  {
                     ...
                     _loc4_.draw(var_99,var_866,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
            ...
            var_234.left = int.MAX_VALUE;
            var_234.top = int.MAX_VALUE;
            var_234.right = int.MIN_VALUE;
            var_234.bottom = int.MIN_VALUE;
         }
         return true;
      }
      ...
      {
         var _loc2_:ISkinRenderer = var_679.getSkinRendererByType(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_860)
            {
               _loc2_ = var_679.getSkinRendererByType(param1.type,WindowStyle.const_860);
            }
         }
         return _loc2_;
      }
