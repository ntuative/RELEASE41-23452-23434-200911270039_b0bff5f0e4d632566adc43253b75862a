package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1382:String = "_INCLUDE";
      
      public static const const_967:String = "_EXCLUDE";
      
      public static const const_1533:String = "_TEMP";
      
      private static const const_1005:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1006:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_858:Dictionary;
      
      protected var var_1283:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1031,var_1032);
         var_858 = new Dictionary();
         var_1282 = new Dictionary();
         ParamCodeTable.fillTables(var_858,var_1282);
         var_1283 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1006,"");
         return param1.replace(const_1005,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_858)
            {
               delete var_858[_loc1_];
            }
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_153)
                     {
                        window.x = rect.x;
                     }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_967) == -1)
                  {
