package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_2026:BitmapData = null;
      
      private var var_593:IHabboCommunicationManager;
      
      private var var_673:int = 0;
      
      private var _config:IHabboConfigurationManager;
      
      private var var_2027:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_420,0,0,_loc4_,var_1468,var_2027,var_2026));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2029 = int(_config.getKey("interstitial.interval","30000"));
         var_2025 = int(_config.getKey("interstitial.show.time","5000"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1468 = _loc2_.clickUrl;
         if(var_1235 != "" && var_1468 != "")
         {
            _loc3_ = var_1235;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         if(var_1236 != "")
         {
            ...
            if(var_232 == null)
            {
               var_232 = new Timer(var_2025,1);
               var_232.addEventListener(TimerEvent.TIMER_COMPLETE,interstitialTimerComplete);
            }
            if(false)
            {
               var_232.reset();
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_433,0,0,param1.bitmapData,var_2028));
            var_673 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_2026 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         var _loc1_:int = getTimer() - var_673;
         if(_loc1_ > var_2029)
         {
            ++var_1469;
      ...
      {
         var_593 = param2 as IHabboCommunicationManager;
         if(var_593 == null)
         {
            return;
         }
         _connection = var_593.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_365));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_2027 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
