package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1505:IWindowContainer;
      
      public static var var_1281:IWindowContainer;
      
      public static var var_1025:int = 6710886;
      ...
      private var var_1373:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager)
      {
         ...
         if(var_1281 == null)
         {
            ...
            var_1281 = _controller.windowManager.buildFromXML(_loc3_.content as XML) as IWindowContainer;
         }
         if(var_1505 == null)
         {
            _loc4_ = _controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1505 = _controller.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
      ...
      private function createWindow() : void
      {
         ...
         var_1373 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_687 = param1;
         var_1373.setSelected(var_1373.getSelectableByName(param1));
         _window.invalidate();
      }
