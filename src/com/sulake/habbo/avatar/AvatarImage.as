package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_987:int = 2;
      
      private static const const_985:String = AvatarSetType.const_38;
      
      private static const const_986:String = "Default";
      
      private static const const_988:int = 125;
       
      
      private var _avatarSubType:int = 0;
      
      private var var_500:AvatarFigureContainer;
      ...
      private var var_143:AvatarImageCache;
      ...
      private var var_419:IAvatarDataContainer;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String)
      {
         ...
         var_500 = new AvatarFigureContainer(param3);
         if(param5 == AvatarType.PET)
         {
            _loc6_ = var_500.getPartSetId("pbd");
            solvePetAvatarTypeAndRace(_loc6_);
            _avatarSubType = var_872;
         }
         var_143 = new AvatarImageCache(var_82,this,_assets,var_187);
         setDirection(const_985,const_987);
         var_186 = new Array();
         resetActions();
      }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(var_804 == AvatarType.PET && param1 == AvatarSetType.const_44)
         {
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         _isAnimating = false;
         var _loc1_:Array = var_82.sortActions(var_186);
         if(_loc1_ == null)
         {
            var_499 = new Array(0,0,0);
         }
         else
         {
            var_499 = var_82.getCanvasOffsets(_loc1_,var_187,var_101);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc2_.definition.isAnimation)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_1045 = _loc3_.directionData.offset;
                  }
                  if(_loc3_.hasAvatarData())
                  {
                     var_419 = _loc3_.avatarData;
                  }
               }
            }
            if(_loc2_.actionType == AvatarAction.const_562)
            {
               _isAnimating = true;
            }
      ...
      {
         return var_82.getPartColor(var_500,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_82.getCanvas(var_187,var_164.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_82.getBodyParts(param1,var_164.definition,var_101);
         var _loc7_:int = _loc5_.length - 1;
         while(_loc7_ >= 0)
         {
            _loc9_ = _loc5_[_loc7_];
            _loc10_ = _loc2_.getImageContainer(_loc9_,var_420);
            if(_loc10_ != null)
            {
               ...
               if(var_804 == AvatarType.PET)
               {
                  _loc14_ = getCache().getBodyPartCache(_loc9_);
                  _loc15_ = _loc14_.getAction();
                  _loc16_ = _loc15_.definition.assetPartDefinition;
                  _loc17_ = var_82.getParts(_loc9_,var_500,_loc15_,"pet",_loc14_.getDirection());
                  _loc18_ = 32;
                  if(var_187 == AvatarScaleType.const_95)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     _loc19_ = _loc17_[0];
                     _loc20_ = _loc19_.getFrameIndex(var_420);
                     _loc21_ = var_101;
                     _loc22_ = 1;
                     switch(var_101)
                     {
                     ...
                     _loc23_ = var_82.getPartActionOffset(getSubType(),var_187,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String) : BitmapData
      {
         ...
         {
            _loc3_ = var_82.getCanvas(var_187,var_164.definition.geometryType);
            if(_loc3_ == null)
            {
               return null;
            }
         ...
         var _loc4_:Array = var_82.getBodyParts(param1,var_164.definition,var_101);
         _image.lock();
         ...
         while(_loc6_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,var_420);
            if(_loc8_ != null)
            {
               ...
               if(var_804 == AvatarType.PET)
               {
                  ...
                  _loc14_ = var_82.getParts(_loc7_,var_500,_loc12_,"pet",_loc11_.getDirection());
                  _loc15_ = 32;
                  if(var_187 == AvatarScaleType.const_95)
                  {
                     _loc15_ = 6;
                  ...
                  {
                     _loc16_ = _loc14_[0];
                     _loc17_ = _loc16_.getFrameIndex(var_420);
                     _loc18_ = var_101;
                     _loc19_ = 1;
                     switch(var_101)
                     {
                     ...
                     _loc20_ = var_82.getPartActionOffset(getSubType(),var_187,_loc7_,_loc13_,_loc17_,_loc18_);
                     if(_loc20_ != null)
                     {
         ...
         if(var_419 != null)
         {
            if(false)
            {
               ...
               _image.paletteMap(_image,_image.rect,new Point(0,0),var_419.reds,[],[]);
            }
            else
            {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_164 = new ActiveActionData(AvatarAction.const_864);
         var_164.definition = var_82.getActionDefinition(const_986);
      ...
      {
         return var_82.getBodyPartData(param1.animation.id,var_420,param1.id);
      }
            ...
            case AvatarAction.const_719:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1328:
                     if(var_804 == AvatarType.const_90)
                     {
                        if(var_101 == 0)
                        {
