package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_1441:PaletteManager;
      
      private var var_871:CoreComponent;
      
      private var var_1384:ILogger;
      
      private var var_1212:PetDataManager;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(param1 is CoreComponent)
         {
            ...
            var_871 = CoreComponent(param1);
            var_871.events.addEventListener(Component.COMPONENT_EVENT_RUNNING,onComponentsRunning);
         }
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_550.getValue(AvatarType.const_90) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.init(_habboConfiguration);
         }
         _loc2_ = var_550.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.init(_habboConfiguration);
         }
      ...
      {
         return var_1212 as IPetDataManager;
      }
      ...
      {
         var _loc3_:AvatarStructure = var_550.getValue(AvatarType.const_90) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc3_,var_29,param1,param2,AvatarType.const_90);
      }
      
      public function createPetImageNew(param1:int, param2:int, param3:uint, param4:String) : IAvatarImage
      {
         var _loc5_:String = var_1212.createAvatarFigureStringNew(param1,param2,param3);
         var _loc6_:AvatarStructure = var_550.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:AssetLibraryCollection = var_871.assets as AssetLibraryCollection;
         var _loc3_:int = 0;
         ...
         var_1212 = new PetDataManager(_loc2_,_loc4_);
         var_1441 = new PaletteManager(_loc2_,_loc4_);
         var _loc5_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_1212.populateFigureData(_loc5_);
         _loc6_ = new AvatarStructure(this,assets,_loc2_,AvatarType.const_90);
         _loc6_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_550.add(AvatarType.const_90,_loc6_);
         _loc6_ = new AvatarStructure(this,assets,_loc2_,AvatarType.PET);
         _loc6_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_550.add(AvatarType.PET,_loc6_);
      ...
      {
         var _loc2_:AvatarStructure = var_550.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      private function paletteTest() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:PaletteMap = var_1441.getPalette(0);
