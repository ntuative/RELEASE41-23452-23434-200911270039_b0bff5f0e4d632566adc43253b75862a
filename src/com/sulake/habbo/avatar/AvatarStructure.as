package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1937:PartOffsetData;
      ...
      private var var_803:AvatarActionManager;
      
      private var var_157:IAssetLibrary;
      
      private var var_471:FigureData;
      
      private var var_2157:IAssetLibrary;
      
      private var var_1287:Boolean = false;
      
      private var var_651:AnimationManager;
      
      private var var_1938:AvatarRenderManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_651 = new AnimationManager();
         var_804 = param4;
         var_1937 = PartOffsetData.getInstance(param3);
      }
      
      public function getBodyParts(param1:String, param2:IActionDefinition, param3:int) : Array
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1305[param3];
      ...
      {
         return var_803.getActionDefinitionWithState(param1);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_651.getAnimation(param1);
      }
      ...
      public function init(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_804)
         {
            case AvatarType.const_90:
               _loc3_ = var_157.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_391.parse(_loc3_))
               {
                  return;
               }
               _loc4_ = var_157.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc4_))
               {
                  return;
               }
               _loc5_ = var_157.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_471.parse(_loc5_))
               {
                  return;
               }
               var_1424.add(new AvatarStructureDownload(var_157,_loc2_,var_471));
               _loc6_ = true;
               break;
            case AvatarType.PET:
               _loc3_ = var_157.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_391.parse(_loc3_))
               {
                  return;
               }
               _loc4_ = var_157.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc4_))
               {
                  return;
               }
               _loc5_ = var_157.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_471.parse(_loc5_))
               {
                  return;
               }
      ...
      {
         return var_803.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         return var_803.getActionDefinition(param1);
      }
      
      private function initActions() : void
      {
         var_803 = new AvatarActionManager(var_157,var_804);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_651.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_803.getDefaultActionType();
         var _loc7_:Array = var_391.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_651.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            if(_loc23_ != null)
            {
               _loc24_ = var_471.getPalette(_loc23_.paletteID).getColor(_loc22_);
               ...
               if(_loc25_ != null)
               {
                  ...
                  for each(_loc26_ in _loc25_.parts)
                  {
                     if(_loc9_.indexOf(_loc26_.type) > -1)
                     {
                        ...
                        _loc13_ = var_391.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc33_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_391.getPartDefinition(_loc11_);
                     _loc35_ = false;
                     _loc36_ = 1;
      ...
      private function registerAnimations() : void
      {
         ...
         while(var_157.hasAsset("dance" + _loc1_))
         {
            ...
            var_651.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String) : IPartColor
      {
         ...
         var _loc4_:ISetType = var_471.getSetType(param2);
         if(_loc4_ == null)
         {
            return null;
         }
         return var_471.getPalette(_loc4_.paletteID).getColor(_loc3_);
      }
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_804 + " ready to go!");
      ...
      {
         return var_803.sortActions(param1);
      }
   }
}
