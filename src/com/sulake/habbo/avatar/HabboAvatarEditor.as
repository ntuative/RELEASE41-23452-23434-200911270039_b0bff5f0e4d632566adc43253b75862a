package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_406:IWindowContainer;
      ...
      private var var_1009:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_1009.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_1010)
         {
            ...
            var_682["null"] = new FigureData(this);
            var_682["null"] = new FigureData(this);
            _loc1_ = var_682["null"];
            _loc2_ = var_682["null"];
            ...
            _loc2_.loadAvatarData("hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68",FigureData.const_75);
            var_323 = new Map();
            var_323.add(AvatarEditorCategory.const_903,new GenericModel(this));
            var_323.add(AvatarEditorCategory.const_44,new HeadModel(this));
            var_323.add(AvatarEditorCategory.const_294,new TorsoModel(this));
            var_323.add(AvatarEditorCategory.const_1215,new LegsModel(this));
            var_323.add(AvatarEditorCategory.const_513,new WardrobeModel(this));
            var_1010 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_323.getValue(AvatarEditorCategory.const_513);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_323.getValue(AvatarEditorCategory.const_513);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_1009.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            for each(_loc13_ in _loc10_.colors)
            {
               ...
               {
                  _loc16_ = new AvatarEditorColorItem(AvatarEditorView.var_1505.clone() as IWindowContainer,param1,_loc13_);
                  _loc4_.push(_loc16_);
            ...
            if(_loc8_)
            {
               ...
               _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1281.clone() as IWindowContainer,param1,null,null,false);
            ...
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc19_ = false;
               _loc20_ = true;
               if(_loc5_.gender == FigureData.const_1261)
               {
                  _loc19_ = true;
               }
               ...
               {
                  _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1281.clone() as IWindowContainer,param1,_loc5_,_loc11_,_loc14_);
                  _loc3_.push(_loc6_);
               }
            }
         }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_406 == null)
            {
               var_406 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_53,HabboWindowStyle.const_39,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_406.addChild(_view.window);
               var_406.center();
               var_406.visible = false;
            }
            var_406.visible = true;
         }
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_903);
         if(var_176 != null)
         {
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1102 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_28 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_521,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_1009 = var_1102.getFigureData(AvatarType.const_90);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         var_1008 = param3;
         var _loc4_:FigureData = var_682[param2];
         if(_loc4_ == null)
         {
            return;
         }
