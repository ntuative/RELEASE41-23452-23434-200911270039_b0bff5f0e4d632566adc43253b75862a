package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1349 = new Dictionary();
         super();
         _id = String(param1.@id);
         _state = String(param1.@state);
         var_1715 = parseInt(param1.@precedence);
         var_1716 = String(param1.@activepartset);
         var_1713 = String(param1.@assetpartdefinition);
         var_1718 = String(param1.@lay);
         var_1216 = String(param1.@geometrytype);
         var_1695 = Boolean(parseInt(param1.@main));
         var_1714 = Boolean(parseInt(param1.@name_1));
         var_1717 = Boolean(parseInt(param1.@animation));
         var _loc2_:String = String(param1.@prevents);
         if(_loc2_ != "")
         {
            var_1111 = _loc2_.split(",");
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            var_499.add(param1,new Map());
         }
         var _loc4_:Map = var_499.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = var_499.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         return var_1111.concat(getTypePrevents(param1));
      }
