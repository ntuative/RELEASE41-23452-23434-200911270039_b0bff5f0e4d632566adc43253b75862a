package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1474,var_1473,var_1475,_alphaMultiplier);
         var_979 = generatePaletteMapForGrayscale(var_1956,var_1954);
      }
      
      public function get reds() : Array
      {
         return var_979.getValue("reds") as Array;
      }
      ...
      {
         return var_979.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_979.getValue("greens") as Array;
      }
      ...
      {
         return var_979.getValue("alphas") as Array;
      }
