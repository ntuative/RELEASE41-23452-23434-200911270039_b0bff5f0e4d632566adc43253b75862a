package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         ...
         var _loc2_:AvatarImageBodyPartCache = var_143.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            var_143.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         {
            _loc15_ = var_82.getBodyPartData(_loc5_.definition.state + "." + _loc5_.actionParameter,param2,param1);
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_536)
               {
                  _loc6_ = _loc15_.action;
                  _loc4_ = _loc8_;
               }
               else if(_loc15_.type == AnimationLayerData.const_352)
               {
                  _loc4_ = _loc8_;
               }
               _loc7_ = true;
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_82.getParts(param1,(var_821 as AvatarImage).getFigure(),_loc6_,var_1216,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_82.getCanvas(var_187,var_1216);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1251[param1])
            {
            ...
            else
            {
               ...
               {
                  _loc34_ = var_82.renderManager.paletteManager.getPalette(_loc7_.paletteMapId);
               ...
               if((_loc32_ == AvatarAction.const_848 || _loc32_ == AvatarAction.const_562) && (_loc6_ == AvatarBodyPartType.const_294 || _loc6_ == AvatarBodyPartType.const_1302 || _loc6_ == AvatarBodyPartType.const_1143) && _loc7_.color != null)
               {
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         if(var_143 != null)
         {
            _loc2_ = var_143.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc4_ = var_143.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc4_ != null)
               {
