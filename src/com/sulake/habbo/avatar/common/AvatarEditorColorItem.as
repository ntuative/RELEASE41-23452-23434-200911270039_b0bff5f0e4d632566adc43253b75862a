package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorColorItem
   {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_598.width,var_598.height,true,0);
            _loc1_.bitmap.copyPixels(var_598,var_598.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_1080.width,var_1080.height,true,0);
            _loc4_ = var_1080.clone();
            _loc4_.colorTransform(_loc4_.rect,var_734.colorTransform);
         ...
         if(_loc3_ != null)
         {
            _loc3_.bitmap = new BitmapData(var_892.width,var_892.height,true,16777215);
            _loc3_.bitmap.copyPixels(var_892,var_892.rect,new Point(0,0),null,null,true);
            if(!_isSelected)
            {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               _loc5_.bitmap.copyPixels(var_1335,var_1335.rect,new Point(0,0),null,null,true);
            }
         }
      }
