package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridItem
   {
      ...
      private static var var_86:Array = [];
      ...
      {
         var _loc3_:Number = var_86.indexOf(param1.type);
         var _loc4_:Number = var_86.indexOf(param2.type);
         if(_loc3_ < _loc4_)
         {
            return -1;
         }
      ...
      private function updateThumbData() : void
      {
         ...
         if(var_569 != null && false)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               _loc6_.bitmap.copyPixels(var_1335,var_1335.rect,new Point(0,0),null,null,true);
            }
         }
         if(isSelected)
         {
      ...
      private function renderThumb() : BitmapData
      {
         ...
         _loc1_ = new BitmapData(var_842.width,var_842.height,true,16777215);
         for each(_loc2_ in partSet.parts.concat().sort(sortByDrawOrder))
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_907 + "_" + FigureData.const_262;
            ...
            if(_loc4_ != null)
            {
               ...
               if(_color != null && var_1018 && _loc2_.isColorable)
               {
      ...
      private function analyzeLayers() : void
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_907 + "_" + FigureData.const_262;
