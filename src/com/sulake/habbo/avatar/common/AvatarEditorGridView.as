package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridView
   {
      ...
      private var var_831:IItemGridWindow;
      
      private var var_1478:IItemGridWindow;
      ...
      public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
      {
         ...
         if(_view != null)
         {
            var_831 = _view.findChildByName("thumbs") as IItemGridWindow;
            var_1478 = _view.findChildByName("colors") as IItemGridWindow;
         }
      }
      ...
      private function paletteEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = var_1478.getGridItemIndex(param1.window);
      ...
      {
         var _loc3_:IWindow = var_831.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_55)
         {
            _loc3_ = var_831.getGridItemIndex(param1.window);
