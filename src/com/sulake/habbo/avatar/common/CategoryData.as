package com.sulake.habbo.avatar.common
{
   public class CategoryData
   {
      ...
      public function get currentColour() : AvatarEditorColorItem
      {
         if(var_633 > -1)
         {
            return var_328[var_633] as AvatarEditorColorItem;
         }
         return null;
      }
      ...
      public function selectColour(param1:int) : AvatarEditorColorItem
      {
         ...
         if(var_633 >= 0)
         {
            _loc3_ = var_328[var_633];
            _loc3_.isSelected = false;
         }
         if(var_328.length > param1)
         {
            _loc2_ = var_328[param1] as AvatarEditorColorItem;
            _loc2_.isSelected = true;
         }
         var_633 = param1;
