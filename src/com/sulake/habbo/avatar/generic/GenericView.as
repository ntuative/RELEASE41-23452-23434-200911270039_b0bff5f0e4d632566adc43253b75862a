package com.sulake.habbo.avatar.generic
{
   ...
   public class GenericView implements IAvatarEditorCategoryView
   {
      ...
      public function GenericView(param1:GenericModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_603["null"] = new AvatarEditorGridView(param1,FigureData.const_52,param2,param3);
         attachImages();
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "tab_boy":
                  ...
                  break;
               case "tab_girl":
                  var_90.categorySwitch(FigureData.const_75);
                  param1.stopPropagation();
            }
         }
      ...
      {
         var _loc4_:AvatarEditorGridView = var_603[param1];
         if(_loc4_ != null)
         {
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:AvatarEditorGridView = var_603[var_1339];
         if(_loc4_ == null)
         {
            return;
         }
