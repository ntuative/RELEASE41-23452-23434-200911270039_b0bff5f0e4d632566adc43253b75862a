package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:Array = var_1342.concat();
         for each(_loc2_ in var_910)
         {
