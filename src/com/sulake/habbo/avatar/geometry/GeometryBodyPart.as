   ...
   public class GeometryBodyPart extends Node3D
   {
      ...
      public function GeometryBodyPart(param1:XML)
      {
         ...
         for each(_loc2_ in param1..item)
         {
            ...
            var_538[String(_loc2_.@id)] = _loc3_;
         }
      }
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in var_538)
         {
            if(_loc1_ != null)
            {
               if(_loc1_.isDynamic)
               {
                  var_538[_loc1_.id] = null;
                  _loc1_ = null;
               }
            }
         }
      ...
      {
         var _loc2_:GeometryItem = var_538[param1];
         return _loc2_ != null;
      }
