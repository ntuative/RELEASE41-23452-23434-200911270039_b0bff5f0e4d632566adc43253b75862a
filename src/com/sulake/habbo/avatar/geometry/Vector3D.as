package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      public function cross(param1:Vector3D) : Vector3D
      {
         ...
         _loc2_.y = var_88 * param1.x - var_89 * param1.z;
      ...
      {
         return Math.sqrt(var_89 * var_89 + _y * _y + var_88 * var_88);
      }
      ...
      {
         return var_89 * param1.x + _y * param1.y + var_88 * param1.z;
      }
      ...
      {
         return "Vector3D: (" + var_89 + "," + _y + "," + var_88 + "," + var_1015 + ")";
      }
