package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_603 = new Dictionary();
         var_603["null"] = new AvatarEditorGridView(param1,FigureData.const_115,param2,param3);
         var_603["null"] = new AvatarEditorGridView(param1,FigureData.const_147,param2,param3);
         var_603["null"] = new AvatarEditorGridView(param1,FigureData.const_137,param2,param3);
         var_603["null"] = new AvatarEditorGridView(param1,FigureData.const_134,param2,param3);
         var_603["null"] = new AvatarEditorGridView(param1,FigureData.const_146,param2,param3);
         attachImages();
      ...
      private function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result.length)
         {
            ...
            {
               bmp.bitmap = new BitmapData(bmp.width,bmp.height,false,AvatarEditorView.var_1025);
      ...
      private function changeToCurrentTab() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_603[var_1339];
         if(_loc2_ == null)
         {
            return;
         }
