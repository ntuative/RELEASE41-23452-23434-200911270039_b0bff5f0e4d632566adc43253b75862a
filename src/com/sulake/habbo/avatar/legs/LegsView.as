package com.sulake.habbo.avatar.legs
{
   ...
   public class LegsView implements IAvatarEditorCategoryView
   {
      ...
      public function LegsView(param1:LegsModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_603["null"] = new AvatarEditorGridView(param1,FigureData.const_127,param2,param3);
         var_603["null"] = new AvatarEditorGridView(param1,FigureData.const_170,param2,param3);
         var_603["null"] = new AvatarEditorGridView(param1,FigureData.const_138,param2,param3);
         attachImages();
