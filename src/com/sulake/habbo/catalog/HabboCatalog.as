package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_629:PurchaseConfirmationDialog;
      ...
      private var var_382:ICatalogNavigator;
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_196.credits = _loc3_.balance;
         updatePurse();
         if(!var_1817 && var_808 != null)
         {
            var_808.playSound(HabboSoundTypesEnum.const_977);
         }
         var_1817 = false;
      }
      ...
      {
         return var_530.getFurnitureData(param1);
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_82:
               var_1148 = param1.session.isPrivateRoom;
               if(var_91 != null)
               {
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_204.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_184,false);
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_382 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_196.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_196.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         updatePurse();
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_629 == null)
            {
               var_629 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_629.showOffer(this,param1,param2,param3,_loc7_);
         }
      }
      ...
      {
         var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_382.buildCatalogIndex(_loc2_);
         if(var_938 != "")
         {
            var_382.openPage(var_938);
            var_938 = "";
         }
         else
         {
            var_382.openFrontPage();
         }
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_196.pixels = _loc2_.amount;
         updatePurse();
         if(!var_1818 && var_808 != null)
         {
            var_808.playSound(HabboSoundTypesEnum.const_945);
         }
         var_1818 = false;
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_196.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_196.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_196.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_196.clubPeriods));
         if(false)
         {
            return;
         }
