package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog
   {
      ...
      private var var_568:ITextWindow;
         ...
         switch(_loc2_)
         {
            case "button_ok":
               if(var_567)
               {
                  ...
                  HabboCatalog(var_72).purchaseProduct(var_642,var_180,var_1016,true,_loc5_,_loc6_);
               }
               else
               {
                  HabboCatalog(var_72).purchaseProduct(var_642,var_180,var_1016);
               }
               dispose();
               break;
            case "button_cancel":
      ...
      private function showDialog() : void
      {
         ...
         if(_loc4_)
         {
            ...
            _loc17_.addEventListener(WindowEvent.const_643,onDeActivateGift);
      ...
      private function updateSuggestions(param1:Array, param2:IWindow) : void
      {
         ...
         if(var_145 == null)
         {
            ...
            var_145 = var_72.windowManager.buildFromXML(_loc5_.content as XML) as IItemListWindow;
            if(var_145 != null)
            {
               var_568 = var_145.getListItemAt(0) as ITextWindow;
               var_568.procedure = suggestionsEventHandler;
            }
         }
         if(var_145 == null || var_568 == null)
         {
            return;
         }
         ...
         {
            _loc6_ = var_568.clone() as ITextWindow;
            if(_loc6_ != null)
            {
               _loc6_.text = _loc3_;
