package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1264:EventDispatcher;
      
      private var _widgets:Array;
      
      private var _pageId:int;
      
      private var var_833:ICatalogViewer;
      ...
      {
         return _localization.hasLinks(var_843);
      }
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1112) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1208) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1093) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1264;
            _loc2_.init();
         }
         var_1264.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1264.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_843);
      }
