package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         if(var_280 != null)
         {
            _loc2_ = var_280.getChildByName("chosen");
            if(_loc2_ != null)
            {
      ...
      private function populateColourGrid() : void
      {
         ...
         for each(_loc1_ in var_1081)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_598.width,var_598.height,true,0);
               _loc3_.bitmap.copyPixels(var_598,var_598.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_1080.width,var_1080.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_892.width,var_892.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_892,var_892.rect,new Point(0,0),null,null,true);
