package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_522[var_923] as Array;
      ...
      {
         var _loc2_:Offer = var_522[var_923][var_1724];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_366 || _loc1_.pricingModel == Offer.const_411)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_141 || _loc3_.productType == ProductTypeEnum.const_162)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_922.indexOf(_loc5_) == -1)
                        {
                           var_922.push(_loc5_);
                           var_522.push(new Array());
                        }
                        _loc6_ = var_922.indexOf(_loc5_);
                        (var_522[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_522)
         {
            if(var_1724 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1724] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_923 = var_870.getGridItemIndex(param1.view);
