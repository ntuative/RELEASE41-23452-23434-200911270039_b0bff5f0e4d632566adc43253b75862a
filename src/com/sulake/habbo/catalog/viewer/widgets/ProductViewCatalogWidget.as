package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_562:IItemGridWindow;
      
      private var var_93:IBitmapWrapperWindow;
      
      private var var_1263:ITextWindow;
      
      private var var_1246:IScrollbarWindow;
      
      protected var var_1289:XML;
      
      private var var_1245:BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_562 != null)
         {
            var_562.visible = false;
            var_562.destroyGridItems();
         }
         if(var_1246 != null)
         {
            var_1246.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1263.text = "${" + _loc3_.name + "}";
            var_1262.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1263.text = "${" + _loc2_.localizationId + "}";
            var_1262.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_378:
                  _loc4_ = var_1245.clone();
                  if(var_562 != null)
                  {
                     var_562.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_562,var_1246,var_1289);
                  }
                  break;
               ...
               case Offer.const_411:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_282:
                        ...
                        _loc4_ = new BitmapData(var_93.width,var_93.height,false,_loc10_);
                        _loc11_ = null;
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_309,AvatarAction.const_548);
                              _loc13_.appendAction(AvatarAction.const_553,_loc6_.productClassId);
      ...
      {
         var_1263 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1262 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_93 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1476 = new Point(var_93.x,var_93.y);
         var_562 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1246 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_562 == null)
         {
         ...
         var_1245 = _loc2_.content as BitmapData;
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(var_93);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Point = null) : void
      {
         ...
         if(true)
         {
            var_93.bitmap = new BitmapData(var_93.width,var_93.height,true,16777215);
         }
         var_93.bitmap.fillRect(var_93.bitmap.rect,16777215);
         var _loc3_:Point = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
         var_93.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         var_93.invalidate();
         var_93.x = var_1476.x;
         var_93.y = var_1476.y;
         if(param2 != null)
