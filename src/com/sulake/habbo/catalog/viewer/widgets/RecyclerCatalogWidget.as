package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IRecyclerVisualization
   {
      ...
      private var var_241:CatalogObjectMover;
      ...
      private function onMainContainerEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_28:
               if(var_241 != null)
               {
                  var_241.onMainContainerEvent(param1,param2,_loc4_);
               }
               break;
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               if(var_241 == null)
               {
                  var_241 = new CatalogObjectMover();
                  var_241.mainContainer = window;
                  var_241.roomEngine = _loc3_;
               }
               var_241.onMainContainerEvent(param1,param2,_loc4_);
         }
      }
