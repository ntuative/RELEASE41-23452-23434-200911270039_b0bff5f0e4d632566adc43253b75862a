package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_833:PrizeViewer;
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            createLevelItem(var_681[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_833 = new PrizeViewer();
         var_894 = new Map();
         var_681 = recycler.getPrizeTable();
         if(var_681 == null)
         {
            return;
         }
         ...
         var_2054 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_681[0].prizes.length > 0)
         {
            select(var_681[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_2054) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1289) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_833.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
