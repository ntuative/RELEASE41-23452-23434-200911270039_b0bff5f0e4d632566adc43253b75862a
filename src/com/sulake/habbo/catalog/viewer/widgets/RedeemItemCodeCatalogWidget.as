package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_971:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_970 != null)
         {
            var_970.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_971 != null)
         {
            var_971.removeEventListener(WindowKeyboardEvent.const_131,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_970 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_970 != null)
         {
            var_970.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_971 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_971 != null)
         {
            var_971.addEventListener(WindowKeyboardEvent.const_131,windowKeyEventProcessor);
         }
      }
