package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1158:String = "default";
      ...
      private var var_1159:String = "1.1";
      ...
      private var var_986:BitmapData = null;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_985 != null && var_986 != null)
         {
            setRoomImage(var_985,var_986);
         }
      }
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_174:
               ...
               if(var_296 == _activeWallpaperPatterns.length)
               {
                  var_296 = 0;
               }
               var_227 = 0;
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1158);
               }
               break;
            ...
            case "ctlg_buy_landscape":
               _loc3_ = var_1211[var_295];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1159);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1158,var_1159,64,this,"window_romantic_wide");
