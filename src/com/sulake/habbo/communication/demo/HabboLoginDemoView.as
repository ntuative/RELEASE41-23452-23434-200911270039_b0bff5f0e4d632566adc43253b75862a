package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_543:String = "InitConnection";
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_315.shockwaveClientUrl = var_115.shockwaveClientUrl;
         var_315.ssoTicket = var_115.ticket;
         var_115.removeEventListener(SSOTicket.const_284,onParsedTicketSuccess);
         var_115.removeEventListener(SSOTicket.const_242,onParsedTicketFailure);
         var_115 = null;
         dispatchEvent(new Event(const_543));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1346,"/");
      ...
      private function createWindow() : void
      {
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1346,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         var_115 = new SSOTicket(var_315.assets,_loc2_,_loc1_);
         var_115.addEventListener(SSOTicket.const_284,onParsedTicketSuccess);
         var_115.addEventListener(SSOTicket.const_242,onParsedTicketFailure);
      }
