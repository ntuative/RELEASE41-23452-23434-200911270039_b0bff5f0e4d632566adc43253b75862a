package com.sulake.habbo.communication.messages.incoming.avatar
{
   ...
   public class CheckUserNameResultMessageEvent extends MessageEvent implements IMessageEvent
   {
      ...
      public static var var_1027:int = 3;
      
      public static var var_1028:int = 5;
      
      public static var var_855:int = 0;
      
      public static var var_1026:int = 4;
      
      public static var var_1029:int = 2;
      
      public static var var_1024:int = 1;
