package com.sulake.habbo.communication.messages.incoming.navigator
{
   ...
   public class OfficialRoomsData implements IDisposable, MsgWithRequestId
   {
      ...
      public function OfficialRoomsData(param1:IMessageDataWrapper)
      {
         ...
         while(_loc3_ < _loc2_)
         {
            var_1224.push(new NavigationNodeData(param1.readInteger(),param1.readString()));
            _loc3_++;
         }
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            var_664.push(_loc6_);
            if(_loc6_.type == OfficialRoomEntryData.const_930)
            {
               var_1224.push(new NavigationNodeData(_loc6_.flatCategoryId,_loc6_.popupCaption));
            }
            _loc5_++;
         }
      }
