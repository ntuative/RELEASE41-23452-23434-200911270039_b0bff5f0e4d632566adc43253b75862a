         ...
         if(_loc3_.selected)
         {
            switch(_loc3_.id)
            {
               case FriendListTab.const_79:
                  _friendList.method_2(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS);
                  break;
               case FriendListTab.const_312:
                  _friendList.method_2(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH);
                  break;
               case FriendListTab.const_98:
                  _friendList.method_2(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST);
            }
         }
         else
         {
            _friendList.method_2(HabboFriendListTrackingEvent.const_300);
         }
      }
