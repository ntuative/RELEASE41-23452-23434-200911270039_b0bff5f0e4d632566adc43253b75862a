package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1364:String = "no_reqs_info";
       
      
      private var var_1432:IContainerButtonWindow;
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_302 && _loc4_.state != FriendRequest.const_322)
            {
      ...
      {
         var_1432 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1433 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1433.procedure = onDismissAllButtonClick;
         var_1432.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = _friendList.laf.getRowShadingColor(FriendListTab.const_98,param2);
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_796)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1432,_loc1_);
         setEnabled(var_1433,_loc1_);
      }
