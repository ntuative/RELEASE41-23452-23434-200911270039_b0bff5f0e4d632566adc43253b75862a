package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      public static const const_160:String = "face";
       
      
      private var _view:FriendListView;
      
      private var var_1617:IAvatarRenderManager;
      
      private var var_1316:AvatarSearchResults;
      
      private var var_128:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_723:FriendRequests;
      ...
      private var var_1614:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_374:FriendListTabs;
      
      private var var_1616:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1315:OpenedToWebPopup;
      ...
      {
         var_1614 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_323 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1316 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1315 == null)
         {
            var_1315 = new OpenedToWebPopup(this);
         }
         var_1315.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_723.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_723.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_374.findTab(FriendListTab.const_98).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_152,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_723.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_723 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_323.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_323.addCategory(new FriendCategory(FriendCategory.const_964,getText("friendlist.friends")));
         var_323.addCategory(new FriendCategory(FriendCategory.const_458,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_323.addFriend(new Friend(_loc4_));
         }
         var_374 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var _loc2_:IAvatarImage = var_1617.createAvatarImage(param1,AvatarScaleType.const_95);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1617 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_723.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_374.findTab(FriendListTab.const_98);
      ...
      {
         var_1616 = param2 as IHabboNotifications;
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.close();
            method_2(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED);
         }
         else
         {
            _view.openFriendList();
            _loc1_ = var_374.findSelectedTab();
            if(_loc1_ == null)
            {
            ...
            else
            {
               switch(_loc1_.id)
               {
                  case FriendListTab.const_79:
                     method_2(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS);
                     break;
                  case FriendListTab.const_312:
                     method_2(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH);
                     break;
                  case FriendListTab.const_98:
                     method_2(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST);
               }
            }
         }
      }
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1316.searchReceived(_loc2_.friends,_loc2_.others);
