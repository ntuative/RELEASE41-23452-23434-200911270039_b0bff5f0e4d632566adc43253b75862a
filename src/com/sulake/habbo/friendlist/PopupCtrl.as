package com.sulake.habbo.friendlist
{
   ...
   public class PopupCtrl
   {
      ...
      {
         var_768 = new Timer(500,1);
         var_622 = new Timer(100,1);
         super();
         _friendList = param1;
         var_1136 = param4;
         var_1779 = param2;
         var_1780 = param3;
         var_768.addEventListener(TimerEvent.TIMER,onDisplayTimer);
         var_622.addEventListener(TimerEvent.TIMER,onHideTimer);
      }
      ...
      public function showPopup(param1:IWindowContainer, param2:IWindow) : void
      {
         if(var_54 == null)
         {
            var_54 = IWindowContainer(_friendList.getXmlWindow(var_1136));
         ...
         var_54.x = _loc4_.x - _loc3_.x + var_1779 + param2.width;
         ...
         {
            var_54.x = 0 + _loc4_.x - _loc3_.x + var_1780;
