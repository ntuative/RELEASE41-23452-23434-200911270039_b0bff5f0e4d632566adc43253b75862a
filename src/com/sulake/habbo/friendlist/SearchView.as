package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_612:ITextFieldWindow;
      ...
      {
         var_612 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_612.procedure = onSearchInput;
         var_612.addEventListener(WindowKeyboardEvent.const_131,onSearchStrInput);
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_612.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
