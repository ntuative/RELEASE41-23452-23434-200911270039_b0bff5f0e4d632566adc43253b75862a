package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1479:int = "F".charCodeAt(0);
      
      public static const const_1380:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         var_604 = param1.online;
         var_1098 = param1.followingAllowed && param1.online;
         var_500 = param1.figure;
         var_1180 = param1.motto;
         var_1183 = param1.lastAccess;
         var_1181 = param1.categoryId;
         var_1182 = param1.realName;
