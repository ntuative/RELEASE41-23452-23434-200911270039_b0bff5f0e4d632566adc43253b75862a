package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_2086:UserRegistry;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_144:TutorialUI;
      
      private var var_1484:IHabboLocalizationManager;
      ...
      public function reportUser(param1:int, param2:String) : void
      {
         ...
         var_64.showUI(HabboHelpViewEnum.const_286);
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_204 != null)
         {
            var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.HELP));
         }
      }
      ...
      private function createHelpUI() : Boolean
      {
         ...
         {
            var_64 = new HelpUI(this,_assetLibrary,_windowManager,var_1484,var_204);
         }
         return var_64 != null;
      }
      ...
      {
         var_1484 = IHabboLocalizationManager(param2);
      ...
      {
         var_593 = IHabboCommunicationManager(param2);
         var_1396 = new IncomingMessages(this,var_593);
      ...
      {
         if(var_593 != null && param1 != null)
         {
            var_593.getHabboMainConnection(null).send(param1);
         }
      }
