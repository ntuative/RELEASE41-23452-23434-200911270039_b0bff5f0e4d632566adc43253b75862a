package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_43.tellUI(HabboHelpViewEnum.const_199,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_43.tellUI(HabboHelpViewEnum.const_246,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_43.tellUI(HabboHelpViewEnum.const_132);
      }
      ...
      {
         var_43.showUI(HabboHelpViewEnum.const_286);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_43.showUI(HabboHelpViewEnum.const_403);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_43.showUI(HabboHelpViewEnum.const_684);
         var_43.tellUI(HabboHelpViewEnum.const_684,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_385)
            {
         ...
         var_43.tellUI(HabboHelpViewEnum.const_545);
      }
