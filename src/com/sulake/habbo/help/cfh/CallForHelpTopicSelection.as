package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_594 == null || _loc3_ < 0 || _loc3_ >= var_594.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_594[_loc3_];
            main.showUI(HabboHelpViewEnum.const_641);
            main.tellUI(HabboHelpViewEnum.const_641,null);
         }
      }
   }
}
