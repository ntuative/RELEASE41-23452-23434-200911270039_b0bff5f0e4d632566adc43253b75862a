package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2056:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","23452-23434-200911270013");
         var_204 = param5;
         var_111 = new Map();
         var_111.add(HabboHelpViewEnum.const_1273,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_132,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_403,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_246,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_199,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_684,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_286,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_641,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_187,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_111.add(HabboHelpViewEnum.const_773,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_111.add(HabboHelpViewEnum.const_545,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_269 == HabboHelpViewEnum.const_132 || false)
         {
            return;
         }
         if(var_405 == null)
      ...
      {
         return var_111.getValue(var_269);
      }
      ...
      {
         var_2057 = param1;
         var _loc2_:IHelpViewController = var_111.getValue(HabboHelpViewEnum.const_132) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_187:
               showUI(HabboHelpViewEnum.const_187);
               break;
            case CallForHelpResultEnum.const_811:
               showUI(HabboHelpViewEnum.const_773);
               break;
      ...
      {
         var _loc3_:* = null;
         if(var_269 == HabboHelpViewEnum.const_132)
         {
            return;
         }
         if(true)
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1482;
         _window.width = _loc1_.width + var_1481;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_269);
            return;
         }
         ...
         if(_loc3_)
         {
            if(var_204 != null)
            {
               var_204.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_43.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_656));
      }
