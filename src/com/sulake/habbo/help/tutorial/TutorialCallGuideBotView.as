package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialCallGuideBotView implements ITutorialUIView
   {
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_152,HabboToolbarIconEnum.HELP);
         if(param1)
         {
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         var_55.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.HELP_ARROW,var_551));
      }
