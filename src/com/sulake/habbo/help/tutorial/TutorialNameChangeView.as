package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_1298:uint = 13232628;
      ...
      private var var_240:IBorderWindow;
      
      private var var_698:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         var_55.localization.registerParameter("help.tutorial.name.available","name",var_356);
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "button_ok":
                  ...
                  break;
               case "button_cancel":
                  var_55.showView(TutorialUI.const_85);
                  break;
               case "button_usecurrent":
                  var_356 = var_55.help.ownUserName;
                  showConfirmationView(true);
                  break;
               case "button_name_check":
                  if(_loc3_.text.length < 1)
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            var_55.localization.registerParameter("help.tutorial.name.confirmation","name",var_356);
         }
         if(var_240 == null)
         {
            var_240 = var_55.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_240 == null)
            {
               return;
            }
            ...
            _loc2_.addChild(var_240);
            var_240.procedure = confirmationViewEventHandler;
         }
         _window.visible = !param1;
         var_240.visible = param1;
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_1028:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1026:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1024:
               break;
         ...
         _loc5_.visible = true;
         var_698 = new NameSuggestionListRenderer(var_55);
         var _loc6_:int = var_698.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1298;
