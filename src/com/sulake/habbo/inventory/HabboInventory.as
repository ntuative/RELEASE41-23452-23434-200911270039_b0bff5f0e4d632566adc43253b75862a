package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1557:int = 500;
      ...
      private var var_1396:IncomingMessages;
      ...
      override public function dispose() : void
      {
         ...
         var _loc4_:* = null;
         super.dispose();
         var _loc1_:Array = var_57.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_57.getValue(_loc3_) as IInventoryModel;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
         ...
         if(var_34 != null)
         {
            var_34.events.removeEventListener(RoomSessionEvent.const_82,roomSessionEventHandler);
            var_34.events.removeEventListener(RoomSessionEvent.const_97,roomSessionEventHandler);
            var_34.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_427,roomSessionEventHandler);
      ...
      {
         return RecyclerModel(var_57.getValue(InventorySubCategory.RECYCLER));
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_97:
               _roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_427:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_57.getValue(InventoryCategory.const_716));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_57.getValue(InventoryCategory.const_72));
      }
      ...
      {
         var_196.clubPeriods = param1;
         var_196.clubDays = param2;
         var_196.clubHasEverBeenMember = param3;
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_897));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_57.getValue(InventoryCategory.const_156));
      }
      ...
      {
         var _loc2_:IInventoryModel = var_57.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1557);
         }
      }
      
      public function getCategoryWindowContainer(param1:String) : IWindowContainer
      {
         var _loc2_:IInventoryModel = IInventoryModel(var_57.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         return AchievementsModel(var_57.getValue(InventoryCategory.const_304));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_784.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_784.splice(_loc3_,1);
            }
         }
      }
      ...
      public function closingInventoryView() : void
      {
         ...
         {
            _loc2_ = var_57.getWithIndex(_loc1_) as IInventoryModel;
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         {
            _loc3_ = var_57.getWithIndex(_loc2_) as IInventoryModel;
      ...
      {
         return TradingModel(var_57.getValue(InventorySubCategory.const_245));
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1396 = new IncomingMessages(this);
      ...
      {
         return var_196.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_196.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_57.getValue(InventoryCategory.const_225));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionEvent.const_82,roomSessionEventHandler);
         var_34.events.addEventListener(RoomSessionEvent.const_97,roomSessionEventHandler);
         var_34.events.addEventListener(RoomSessionPropertyUpdateEvent.const_427,roomSessionEventHandler);
         ...
         var_57.add(InventoryCategory.const_72,_loc3_);
         var _loc4_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_530);
         var_57.add(InventoryCategory.const_225,_loc4_);
         var _loc5_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_57.add(InventoryCategory.const_716,_loc5_);
         var _loc6_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_530);
         var_57.add(InventoryCategory.const_304,_loc6_);
         var _loc7_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_57.add(InventorySubCategory.const_245,_loc7_);
         var _loc8_:RecyclerModel = new RecyclerModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_57.add(InventorySubCategory.RECYCLER,_loc8_);
         ...
         var_57.add(InventoryCategory.const_156,_loc9_);
