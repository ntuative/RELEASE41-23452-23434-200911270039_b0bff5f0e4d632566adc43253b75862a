package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(var_687 == InventoryCategory.const_156)
            {
               toggleCategoryView(InventoryCategory.const_156);
            }
            else if(var_687 == InventoryCategory.const_72)
            {
      ...
      public function toggleSubCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            ...
            if(var_204 != null && var_839)
            {
               var_204.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
            }
         }
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         if(var_204 != null)
         {
            var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setSubViewToCategory(param1:String) : void
      {
         ...
         if(var_204 != null)
         {
            var_204.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_650,HabboToolbarIconEnum.INVENTORY,var_27 as IWindowContainer));
         }
      }
      ...
      public function showInventory() : void
      {
         ...
         if(var_204 != null && var_839)
         {
            var_204.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            var_839 = false;
         }
         _controller.inventoryViewOpened(var_686);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != var_687 || !_controller.isInventoryCategoryInit(param1))
            {
               setViewToCategory(param1);
            }
            if(var_204 != null && var_839)
