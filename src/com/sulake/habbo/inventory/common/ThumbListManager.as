package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_920:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_520 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_520.width;
         var_97 = var_520.height;
         var_919 = param5;
         var_748 = param6;
         var_216 = Math.floor(var_919 / _thumbWidth);
         var_32 = new BitmapData(var_919,var_748);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_32.height < var_748)
         {
            _loc12_ = new BitmapData(var_32.width,var_748);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_520.width,var_520.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_520.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_520,var_520.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_920 != null)
         {
            _loc1_ = var_920.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_448 = resolveRowCountFromList();
         if(var_448 == 0)
         {
            var_32 = new BitmapData(var_919,var_748);
            return;
         }
         var_32 = new BitmapData(Math.max(var_216 * _thumbWidth,var_919),Math.max(var_448 * var_97,var_748),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_216 && var_32.height < _loc3_.y * var_97)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_216 - 1),var_97);
         _loc2_.copyPixels(var_32,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_216 - 1),0,_thumbWidth,var_32.height);
         _loc2_.copyPixels(var_32,_loc4_,new Point(0,var_97),null,null,true);
         _loc4_ = new Rectangle(0,var_97,_thumbWidth * (var_216 - 1),0 - var_97);
