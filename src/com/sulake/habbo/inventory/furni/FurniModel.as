package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_323:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboLocalizationManager, param7:IHabboConfigurationManager)
      {
         ...
         _assets = param4;
         _roomEngine = param5;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_217,onObjectPlaced);
         var_429 = new Timer(const_999,1);
         var_429.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return _controller.getSubCategoryViewId() == InventorySubCategory.const_245;
      }
         ...
         while(_loc3_ < _loc2_.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_609)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_217,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_429 != null)
            {
               var_429.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_429.stop();
               var_429 = null;
            }
            if(var_125 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Boolean = false) : GroupItem
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         if(param3 == FurniCategory.const_278)
         {
         ...
         if(var_589 == null)
         {
            var_589 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc10_:IWindowContainer = var_589.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_245:
               ...
               break;
            case InventorySubCategory.const_854:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
         ...
         if(param1 == InventoryCategory.const_72 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_42:
                  ...
                  break;
               case const_323:
                  _controller.toggleInventoryPage(InventoryCategory.const_156);
            }
         }
      }
      ...
      {
         if(var_713 && param1.type == RoomEngineObjectEvent.const_217)
         {
         ...
         while(_loc8_ < _loc7_.length)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               while(_loc9_ < _loc2_.length)
               {
                  ...
                  if(_loc10_)
                  {
                     if(var_885 == _loc10_.ref)
                     {
                        cancelFurniInMover();
                     }
                     if(_loc4_.getTotalCount() <= 0)
                     {
                        _view.method_1(_loc3_,_loc9_);
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_280 || _loc3_.category == FurniCategory.const_278 || _loc3_.category == FurniCategory.const_301)
         {
            if(param1)
            {
               return false;
