package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      public function FurniView(param1:FurniModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param4;
         var_486 = new Map();
         var_486.add(FurniModel.const_41,new FurniGridView(var_90,FurniModel.const_41,_windowManager,_assetLibrary,_roomEngine));
         var_486.add(FurniModel.const_42,new FurniGridView(var_90,FurniModel.const_42,_windowManager,_assetLibrary,_roomEngine));
         ...
         else if(param1.type == WindowEvent.const_54)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  switchCategory(FurniModel.const_323);
            }
         }
      }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_486.getValue(var_487);
         if(_loc4_ != null)
         {
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = var_90.getGroupItemInIndex(_loc3_,var_487);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_278)
            {
      ...
      public function method_1(param1:String, param2:int) : void
      {
