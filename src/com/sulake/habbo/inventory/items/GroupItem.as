package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2138:BitmapData;
      
      protected var var_865:Boolean;
      ...
      private const const_1358:Number = 0.2;
      
      protected var var_1286:Boolean;
      
      private const const_1359:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_609)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         if(var_2136 == FurniModel.const_41)
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this);
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1291);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1358;
               _loc1_.blend = const_1358;
            }
            else
            {
               _window.blend = const_1359;
               _loc1_.blend = const_1359;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1286 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2138;
               _loc5_.visible = true;
            }
            else
            {
