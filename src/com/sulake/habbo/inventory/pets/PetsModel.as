package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_156 && false)
         {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1176 && param1.type == RoomEngineObjectEvent.const_217)
         {
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1176 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_35,RoomObjectTypeEnum.const_287,_loc3_.figure);
      ...
      {
         if(var_925.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
