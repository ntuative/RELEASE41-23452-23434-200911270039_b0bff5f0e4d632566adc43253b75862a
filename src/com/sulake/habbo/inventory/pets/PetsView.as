package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_280:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_467 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_521 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_521.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_280 != null)
         {
            var_280.setSelected(false);
         }
         var_280 = param1;
         if(var_280 != null)
         {
            var_280.setSelected(true);
         }
         ...
         if(param1.type == WindowEvent.const_54)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  var_90.switchCategory(FurniModel.const_42);
            }
            selectPetsTab();
         }
      }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_280.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_521.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_467.removeGridItem(_loc2_.window);
         if(var_280 == _loc2_)
         {
            var_280 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_521.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_467.addGridItem(_loc2_.window);
            var_521.add(param1.id,_loc2_);
            if(var_280 == null)
            {
               selectFirst();
            }
