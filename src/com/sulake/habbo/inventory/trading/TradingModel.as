package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_396:uint = 4;
      ...
      public static const const_161:uint = 0;
      
      public static const const_1119:uint = 9;
      
      public static const const_197:uint = 5;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_441 = false;
         var_601 = false;
         var_53.updateItemList(var_600);
         var_53.updateItemList(var_1088);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_53.alertPopup(TradingView.const_952);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_600)
            {
               var_441 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_601 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_53.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_600)
            {
               var_53.alertPopup(TradingView.const_774);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + _state + " NEW STATE: " + param1 + " OWN: " + var_441 + " OTHER: " + var_601);
         ...
         {
            case const_161:
               if(param1 == const_159 || param1 == const_197)
               {
                  _state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < var_210.length)
         {
            _loc2_ = var_210.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         else
         {
            ...
            if(var_210.getValue(_loc6_) == null)
            {
               return false;
            }
            _communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
      ...
      public function close() : void
      {
         if(var_507)
         {
            if(_state != const_161 && _state != const_197)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_161;
            var_28.toggleInventorySubPage(InventorySubCategory.const_854);
            var_507 = false;
         }
         var_53.setMinimized(false);
      }
