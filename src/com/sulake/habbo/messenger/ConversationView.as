package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private var var_1949:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_128 = param1;
         var_1428 = initButton("follow_friend",onFollowButtonClick,param2);
         _list = IItemListWindow(param2.findChildByName("msg_list"));
         var_1949 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_673 || param3.type == Message.const_578 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_472.messages.length - const_754);
         _loc1_ = 0;
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_754 + const_1085)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_128.send(new FollowFriendMessageComposer(var_472.id));
      }
      ...
      {
         if(param1 == Message.const_673)
         {
            return 4294967295;
         }
         if(param1 == Message.const_578)
         {
            return 4292801535;
         }
