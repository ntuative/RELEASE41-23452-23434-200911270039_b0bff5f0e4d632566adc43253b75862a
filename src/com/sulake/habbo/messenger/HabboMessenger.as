package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger
   {
      ...
      private var var_514:Conversations;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_515:MessengerView;
      ...
      {
         var _loc2_:Conversation = var_514.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            var_514.setSelected(_loc2_);
            var_515.openMessenger();
            var_515.refresh(true);
         }
      }
      ...
      {
         var_514.addMessageAndUpdateView(param1);
         if(!var_515.isMessengerOpen())
         {
      ...
      {
         var_514 = new Conversations(new ConversationsDeps(this));
         var_515 = new MessengerView(this);
      ...
      {
         var_514.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_158,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.MESSENGER));
         var _loc3_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_152,HabboToolbarIconEnum.MESSENGER);
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_578,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         addMsg(_loc3_);
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         var_514.setFollowingAllowedAndUpdateView(param1,param2);
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_810,_loc2_.userId,getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         var_514.addMessageAndUpdateView(_loc3_);
      }
