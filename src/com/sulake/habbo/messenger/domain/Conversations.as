package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_576,0,var_388.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      {
         return new Message(Message.const_606,0,getOnlineText(param1),Util.getFormattedNow());
      }
