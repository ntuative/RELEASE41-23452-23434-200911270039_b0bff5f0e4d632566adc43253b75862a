package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1332:IMessageComposer;
      ...
      {
         var_714 = IWindowContainer(var_55.getXmlWindow("chatlog_roomheader"));
         var_715 = IWindowContainer(var_55.getXmlWindow("chatlog_chatline"));
         ...
         var_55.connection.send(var_1332);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_714.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_715.clone());
         _loc4_.color = var_1062[param2.chatterId] != null ? (!!param3 ? 4293570819 : uint(4294955520)) : (!!param3 ? 4288861930 : uint(4294967295));
