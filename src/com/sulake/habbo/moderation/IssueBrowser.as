package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1449:IIssueBrowserView;
      
      private const const_1564:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1562:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1448:IIssueBrowserView;
      
      private const const_1568:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1563:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_229:ITabContextWindow;
      
      private var var_1447:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_336.view.width = var_229.container.width;
         var_336.view.height = var_229.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1563:
               if(var_1448 == null)
               {
                  var_1448 = new MyIssuesView(issueManager,this,var_229.container);
               }
               return var_1448;
            case const_1564:
               if(var_1449 == null)
               {
                  var_1449 = new OpenIssuesView(issueManager,this,var_229.container);
               }
               return var_1449;
            case const_1562:
               if(var_1447 == null)
               {
                  var_1447 = new PickedIssuesView(issueManager,this,var_229.container);
               }
               return var_1447;
            default:
               return null;
