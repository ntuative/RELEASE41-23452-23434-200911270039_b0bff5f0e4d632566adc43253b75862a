package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_393:UserInfoCtrl;
      
      private var var_62:ModerationManager;
      
      private var var_991:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_62.issueManager.releaseBundle(var_158.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_393 = new UserInfoCtrl(_window,var_62);
         var_991 = new UserInfoCtrl(_window,var_62);
         var_393.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_158.getHighestPriorityIssue().reporterUserId);
         var _loc3_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_991.load(_loc3_,var_158.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_62.issueManager.closeBundle(var_158.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc4_:Array = var_158.issues;
         var _loc5_:int = 0;
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = var_158.getHighestPriorityIssue().issueId;
         var_62.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_62,WindowTracker.const_792,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_62 != null && false && var_158 != null)
         {
            var_62.issueManager.removeHandler(var_158.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_393 = new UserInfoCtrl(_window,var_62);
            var_393.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_62.issueManager.closeBundle(var_158.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_62.issueManager.closeBundle(var_158.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      {
         return WindowTracker.const_1104;
      }
   }
}
