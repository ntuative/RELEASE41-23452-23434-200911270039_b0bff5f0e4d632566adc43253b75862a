package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_913:String = "issue_bundle_open";
      
      public static const const_501:String = "issue_bundle_my";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_141 = new Map();
         var_811 = new Map();
         var_552 = new IssueBrowser(this,var_62.windowManager,var_62.assets);
         var_661 = [];
         var_812 = [];
         var_993 = new Map();
      }
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_661 = var_661.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_811.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_811.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1294)
         {
            var_160.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_141)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_811.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_811.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_145)
         {
            ...
            _loc8_ = var_812.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            var_62.soundManager.playSound(HabboSoundTypesEnum.const_905);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_811.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_141.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_413 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
