package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1749.clone());
      ...
      {
         var_1749 = IWindowContainer(var_55.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1095;
      }
   }
}
