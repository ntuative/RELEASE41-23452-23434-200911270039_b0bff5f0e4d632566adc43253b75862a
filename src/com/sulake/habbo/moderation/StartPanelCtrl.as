package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl
   {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_55.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!var_1099 ? 0 : 1,_roomId),var_55,WindowTracker.const_577,_roomId),var_58,false,false,true);
      }
