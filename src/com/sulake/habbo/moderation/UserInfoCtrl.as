package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_741:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         return Math.round(param1 / const_741) + " years ago";
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_781.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_55.getXmlWindow("user_info"));
            var_781.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_55.windowTracker.show(new ModActionCtrl(var_55,_data.userId,_data.userName),_callerFrame,var_951,false,true);
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_55.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_55,WindowTracker.const_867,_data.userId),_callerFrame,var_951,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_55.windowTracker.show(new RoomVisitsCtrl(var_55,_data.userId),_callerFrame,var_951,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_55.windowTracker.show(new SendMsgsCtrl(var_55,_data.userId,_data.userName),_callerFrame,var_951,false,true);
      }
