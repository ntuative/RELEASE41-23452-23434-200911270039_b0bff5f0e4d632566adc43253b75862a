package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      {
         var _loc2_:Dictionary = var_1412[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1412[param1] = _loc2_;
         }
         return _loc2_;
      }
