package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2237:Dictionary;
      ...
      private var var_1735:ISessionDataManager;
      
      private var var_1737:RoomCreateViewCtrl;
      
      private var var_1736:RoomThumbnailRenderer;
      
      private var var_204:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1116:RoomInfoViewCtrl;
      
      private var var_72:IHabboCatalog;
      
      private var var_374:Tabs;
      
      private var var_451:MainViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_451 = new MainViewCtrl(this);
         var_1116 = new RoomInfoViewCtrl(this);
         var_1737 = new RoomCreateViewCtrl(this);
         var_1736 = new RoomThumbnailRenderer(this);
         var_928 = new GuestRoomPasswordInput(this);
         var_334 = new GuestRoomDoorbell(this);
         var_374 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_451.startSearch(Tabs.const_190,Tabs.const_299,param1);
         var_451.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_204.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_204 != null)
         {
            var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_108,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1735 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_451.startSearch(Tabs.const_247,Tabs.const_206);
         var_374.getTab(Tabs.const_247).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_451.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
