package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_152,HabboToolbarIconEnum.EXITROOM);
      ...
      private function onThumbnailUpdated(param1:IMessageEvent) : void
      {
         ...
         _navigator.roomInfoViewCtrl.method_7();
         _navigator.send(new GetGuestRoomMessageComposer(_loc2_.flatId,false,false));
      }
