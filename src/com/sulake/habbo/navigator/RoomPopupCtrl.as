package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1736 = new RoomThumbnailRenderer(param1);
         var_952 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_171,var_117.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_952.refreshTags(_loc1_,var_117.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1736.refreshThumbnail(_loc1_,var_117.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_171,var_117);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_171,!true ? getEventCtg(var_117.categoryId) : getRoomCtg(var_117.categoryId));
         refreshRoomDesc(var_171,var_117);
         refreshExtraCont();
         refreshInfo(var_171,"trading_allowed",var_117.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_190,Tabs.const_198,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
