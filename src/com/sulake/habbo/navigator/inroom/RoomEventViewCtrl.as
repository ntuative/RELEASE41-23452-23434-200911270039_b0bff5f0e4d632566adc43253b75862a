package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         var_1611.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_591.setText(param1.eventDescription);
         var_721.setText(getTagFromEvent(param1,1));
         var_722.setText(getTagFromEvent(param1,2));
         var_1067.visible = false;
         var_1068.visible = true;
         var_1069.visible = true;
         var_1311.visible = false;
         var_1312.visible = true;
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1313 = IWindowContainer(find("event_type_disabled_cont"));
            var_1611 = ITextWindow(find("event_type_disabled_text"));
            var_1311 = ITextWindow(find("create_caption"));
            var_1312 = ITextWindow(find("edit_caption"));
            var_1067 = IButtonWindow(find("create_button"));
            var_1068 = IButtonWindow(find("edit_button"));
            var_1610 = IButtonWindow(find("cancel_button"));
            var_1069 = IButtonWindow(find("end_button"));
            var_720 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1067,onCreateButtonClick);
            Util.setProcDirectly(var_1068,onEditButtonClick);
            Util.setProcDirectly(var_1069,onEndButtonClick);
            Util.setProcDirectly(var_1610,onCancelButtonClick);
            ...
            var_721 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_722 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
      ...
      private function createEvent() : void
      {
         ...
         var_720.selection = 0;
         var_1311.visible = true;
         var_1312.visible = false;
      }
   }
}
