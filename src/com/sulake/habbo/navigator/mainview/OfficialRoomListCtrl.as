package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomListCtrl implements IViewCtrl
   {
      ...
      private static const const_1048:int = -70;
      ...
      private var var_1769:UserCountRenderer;
      ...
      public function OfficialRoomListCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1769 = new UserCountRenderer(_navigator);
      }
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_190,Tabs.const_299,_loc2_.tag);
         }
         ...
         else if(_loc2_.flatCategoryId > 0)
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_226,Tabs.const_362,"" + _loc2_.flatCategoryId,MainViewCtrl.const_662);
         }
         else
         {
      ...
      private function refreshPublicSpaceImage(param1:IWindowContainer, param2:OfficialRoomEntryData, param3:IBitmapWrapperWindow) : void
      {
         ...
         param3.x = !!param2.showDetails ? int(const_1048) : 0;
         param3.width = 274;
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1049) : int(const_1050);
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_575 || param2.type == OfficialRoomEntryData.TYPE_PUBLIC_SPACE))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
            var_1769.refreshUserCount(param2.maxUsers,param1,param2.userCount,"${navigator.usercounttooltip.users}",param1.width - _loc3_ - _loc4_,param1.height - _loc3_ - _loc5_);
         }
      }
