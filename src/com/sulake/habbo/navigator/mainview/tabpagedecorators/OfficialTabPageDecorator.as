package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class OfficialTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_475:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_475 == null)
         {
            var_475 = IDropMenuWindow(_loc3_.findChildByName("officialSubNavi"));
            var_475.procedure = onChangeNavi;
         }
         if(!var_1988 && _navigator.data.topLevelNodes != null)
         {
            prepareNavi();
            var_1988 = true;
         }
      ...
      {
         var _loc3_:* = null;
         var _loc1_:int = var_475 == null ? 0 : int(var_475.selection);
         var _loc2_:int = -1;
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_226,Tabs.const_362,"" + _loc2_,MainViewCtrl.const_662);
      }
