package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_462:IDropMenuWindow;
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = var_462 == null ? 0 : int(var_462.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_254,Tabs.const_281);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_254,Tabs.const_509);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_254,Tabs.const_281,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_462 == null)
         {
            var_462 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_462.procedure = onChangeFilter;
