package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1326:TextSearchInputs;
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_190,Tabs.const_198,"-1",MainViewCtrl.const_630);
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1326 == null)
         {
            ...
            var_1326 = new TextSearchInputs(_navigator,false,_loc4_);
         ...
         {
            var_1326.searchStr.setText(_navigator.data.guestRoomSearchResults.searchParam);
         }
