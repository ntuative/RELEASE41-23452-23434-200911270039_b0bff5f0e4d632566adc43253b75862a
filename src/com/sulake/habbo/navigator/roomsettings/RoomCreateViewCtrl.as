package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_778:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1151 = new Timer(100);
         var_1151.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_67 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_944 = new TextFieldManager(_navigator,ITextFieldWindow(var_33.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_944.getText();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var_1628 = _navigator.data.hcMember;
      }
      ...
      private function refresh() : void
      {
         ...
         var_944.input.textBackgroundColor = 4294967295;
         var_778 = var_67[0];
         if(var_1628 != _navigator.data.hcMember)
         {
      ...
      {
         var _loc1_:Boolean = var_944.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_778.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1150 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1150 = true;
            _loc3_.y = 1;
