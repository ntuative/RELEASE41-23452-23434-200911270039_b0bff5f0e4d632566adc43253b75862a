package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      {
         setEnabled(_bgTabButton,this.var_90.mode != ThumbnailEditorModel.const_37);
         setEnabled(var_1351,this.var_90.mode != ThumbnailEditorModel.const_51);
         setEnabled(var_1352,this.var_90.mode != ThumbnailEditorModel.const_31);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_90.mode = ThumbnailEditorModel.const_37;
         this.reload();
      }
      ...
      private function onCancelButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.roomInfoViewCtrl.method_7();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1351 = IButtonWindow(find("top_tab"));
         var_1352 = IButtonWindow(find("obj_tab"));
         var_1726 = IWindowContainer(find("tile_grid"));
         var_1725 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1351,onTopTabButton);
         Util.setProcDirectly(var_1352,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1726;
         _loc1_.visible = true;
