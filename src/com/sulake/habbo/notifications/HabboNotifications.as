package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, ICoreUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1056:String = "pixelbalance";
      
      private static const const_1052:String = "credits";
      
      private static const const_1055:String = "inventory";
      
      private static const const_1053:String = "friendlist";
      
      private static const const_1057:String = "selectfurni";
      
      private static const const_1054:String = "selectbadge";
      ...
      private var var_1131:IHabboToolbar;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_758);
         }
         var _loc6_:Map = var_758["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1149);
         }
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1312);
         }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1139);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1770)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_916);
            var_1770 = true;
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1102.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_876,_loc5_);
         }
      }
      ...
      {
         if(var_380.isSpaceAvailable() && false)
         {
            var_380.showItem(getNextItemFromQueue());
         }
      }
      ...
      {
         var _loc1_:Array = var_934.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1102.createPetImage(_loc2_.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      {
         if(param2.type == WindowEvent.const_208 || param2.type == WindowEvent.const_554)
         {
            param1.dispose();
         }
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               _loc16_ = var_530.getProductData(_loc15_.productType);
               _loc17_ = var_530.getFurnitureData(_loc15_.furniClassId);
         ...
         if(_loc9_)
         {
            addItem(_loc9_.value,NotificationType.const_916,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_1102.createAvatarImage(param2,AvatarScaleType.const_50);
         if(_loc7_ != null)
         {
      ...
      {
         var_1131 = IHabboToolbar(param2);
         var_1131.events.addEventListener(HabboToolbarEvent.const_77,onHabboToolbarEvent);
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc5_)
         {
            addItem(_loc5_.value,NotificationType.const_182);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_530.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_816);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_816);
            }
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            if(param2 == 3001)
            {
               return FurniCategory.const_278;
            }
            if(param2 == 3002)
            {
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_77)
         {
            ...
            var_380 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_758["styles"],var_758["view"],var_1131);
            ...
            registerUpdateReceiver(var_380,1);
            registerUpdateReceiver(this,2);
            var_530.events.addEventListener(BadgeImageReadyEvent.const_111,onBadgeImage);
            var_1131.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
