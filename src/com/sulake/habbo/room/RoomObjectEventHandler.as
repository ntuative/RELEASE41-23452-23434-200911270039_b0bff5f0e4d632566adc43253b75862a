package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc10_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_929);
      ...
      private function getValidFurnitureDirection(param1:IRoomObjectController, param2:Boolean) : int
      {
         ...
         {
            _loc3_ = param1.getModel().getNumberArray(RoomObjectVariableEnum.const_653);
         }
         ...
         if(_loc7_ != null)
         {
            switch(param1.type)
            {
               ...
               case RoomObjectWidgetRequestEvent.const_119:
                  ...
                  break;
               case RoomObjectWidgetRequestEvent.const_81:
                  _loc7_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_81,param2,param3,_loc4_,_loc6_));
            }
         }
      }
         ...
         if(_roomEngine != null && false)
         {
            switch(param5)
            {
               ...
               case RoomObjectFurnitureActionEvent.const_463:
                  ...
                  break;
               case RoomObjectFurnitureActionEvent.const_349:
      ...
      private function placeObject(param1:int, param2:int) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc5_ == RoomObjectCategoryEnum.const_35 && _loc3_.typeId == RoomObjectTypeEnum.const_287)
               {
         ...
         {
            _roomEngine.events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_217,param1,param2,_loc4_,_loc5_));
         }
         resetSelectedObjectData(param1,param2);
      }
      ...
      private function setObjectAlphaMultiplier(param1:IRoomObjectController, param2:Number) : void
      {
         ...
         {
            param1.getModelController().setNumber(RoomObjectVariableEnum.const_166,param2);
         }
      }
         ...
         if(_loc6_ == null)
         {
            ...
            if(_loc5_.category == RoomObjectCategoryEnum.const_33)
            {
               if(_loc6_ != null)
               {
                  ...
                  {
                     _loc10_ = _loc6_.getModel().getNumberArray(RoomObjectVariableEnum.const_653);
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         var _loc10_:String = var_290.getValue(RoomObjectCategoryEnum.const_188);
         switch(_loc4_)
         {
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               ...
               else
               {
                  ...
                  if(_loc8_ == RoomObjectCategoryEnum.const_35)
                  {
                     if(_loc10_ != null)
                     {
                        var_290.remove(RoomObjectCategoryEnum.const_56);
                        var_290.add(RoomObjectCategoryEnum.const_56,_loc10_);
                     }
                  }
               }
         }
         if(_loc8_ == RoomObjectCategoryEnum.const_56)
         {
            _loc12_ = var_290.getValue(RoomObjectCategoryEnum.const_56) as String;
            if(_loc12_ != _loc10_)
            {
               _loc13_ = _roomEngine.events;
               if(_loc13_ != null)
               {
                  _loc13_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_450,param2,param3,-1,RoomObjectCategoryEnum.const_188));
               }
               setSelectedAvatar(param2,param3,0,false);
            }
         }
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               if(_loc8_ == RoomObjectCategoryEnum.const_33 || _loc8_ == RoomObjectCategoryEnum.const_29)
               {
                  if(param1.altKey)
                  {
                     ...
                     if(_loc10_ != null)
                     {
                        _loc10_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_691,param2,param3,_loc6_,_loc8_));
                     }
                  }
               }
         }
      ...
      private function validateFurnitureLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:TileHeightMap) : Vector3d
      {
         ...
         var _loc8_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_406);
         if(_loc7_ < 1)
         {
            _loc7_ = 1;
         }
      ...
      private function handleObjectRoomAdEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomAdEvent.const_248:
               ...
               _loc7_ = "null";
               break;
            case RoomObjectRoomAdEvent.const_343:
               _loc7_ = "null";
               break;
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:IRoomObjectController = _roomEngine.getRoomObject(param1,param2,var_969,_loc5_) as IRoomObjectController;
         ...
         if(_loc8_ != null && _loc8_.getEventHandler() != null)
         {
            if(_loc7_)
            {
               _loc8_.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_434));
            }
            else
            {
               _loc8_.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_368));
            }
         }
      }
      ...
      private function handleRoomActionEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            switch(param1.type)
            {
               case RoomObjectRoomActionEvent.const_345:
                  ...
                  break;
               case RoomObjectRoomActionEvent.const_369:
      ...
      private function validateFurnitureDirection(param1:IRoomObject, param2:IVector3d, param3:TileHeightMap) : Boolean
      {
         ...
         var _loc7_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_406);
         if(_loc6_ < 1)
         {
            _loc6_ = 1;
         }
         ...
         if(_roomEngine != null)
         {
            ...
            if(_loc8_ != null && _loc8_.getEventHandler() != null)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc8_.getEventHandler().processUpdateMessage(_loc10_);
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_434);
               }
               else
               {
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_368);
               }
               _loc8_.getEventHandler().processUpdateMessage(_loc10_);
            }
         }
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomObjectRoomAdEvent.const_314:
               ...
               break;
            case RoomObjectRoomActionEvent.const_345:
            case RoomObjectRoomActionEvent.const_890:
            case RoomObjectRoomActionEvent.const_369:
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_347:
               _roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_840));
               break;
            case RoomObjectFurnitureActionEvent.const_441:
      ...
      public function processRoomCanvasMouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomObject, param3:String, param4:IRoomGeometry) : void
      {
         ...
         var _loc7_:String = var_290.getValue(_loc6_) as String;
         if(_loc7_ == param3)
         {
         ...
         {
            var_290.remove(_loc6_);
            var_290.add(_loc6_,param3);
         }
