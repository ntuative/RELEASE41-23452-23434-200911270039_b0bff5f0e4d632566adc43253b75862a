package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureRoomDimmerLogic extends FurnitureLogic
   {
      ...
      override public function update() : void
      {
         ...
         {
            _loc1_ = object.getModelController().getString(RoomObjectVariableEnum.const_133);
            if(_loc1_ != null && _loc1_.length > 0)
            {
               object.getModelController().setString(RoomObjectVariableEnum.const_133,"");
      ...
      override public function dispose() : void
      {
         ...
         if(var_1052)
         {
            if(eventDispatcher != null && object != null)
            {
               ...
               _loc7_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_81,_loc1_,_loc2_);
