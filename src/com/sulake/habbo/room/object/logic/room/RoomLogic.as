package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1458:int = 1500;
      
      private var var_1457:int = 255;
      
      private var var_1459:int = 255;
      
      private var var_1221:uint = 16777215;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_592:
                  _loc2_.setString(RoomObjectVariableEnum.const_601,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_701:
                  _loc2_.setString(RoomObjectVariableEnum.const_492,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_711:
                  _loc2_.setString(RoomObjectVariableEnum.const_580,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_364:
                  _loc8_ = "null";
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_851,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_790,int(_loc5_.bgOnly));
            var_1221 = _color;
            var_1457 = var_1240;
            var_996 = _loc11_;
            var_1459 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_505,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_84.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_93,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1144,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1182,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1295,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_93,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_126 || _loc13_ == RoomPlaneData.const_231)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor() : void
      {
         ...
         if(var_818)
         {
            ...
            {
               _loc6_ = var_1221 >> 16 & 255;
               _loc7_ = var_1221 >> 8 & 255;
               _loc8_ = var_1221 & 255;
               _loc9_ = var_996 >> 16 & 255;
               _loc10_ = var_996 >> 8 & 255;
               _loc11_ = var_996 & 255;
               _loc12_ = (_loc1_ - var_818) / var_1458;
               _loc6_ += (_loc9_ - _loc6_) * _loc12_;
               _loc7_ += (_loc10_ - _loc7_) * _loc12_;
               _loc8_ += (_loc11_ - _loc8_) * _loc12_;
               _loc2_ = (_loc6_ << 16) + (_loc7_ << 8) + _loc8_;
               _loc3_ = var_1457 + (var_1459 - var_1457) * _loc12_;
               _color = _loc2_;
               var_1240 = _loc3_;
            }
            ...
            _loc5_.setNumber(RoomObjectVariableEnum.const_505,_loc2_);
         }
      }
   }
}
