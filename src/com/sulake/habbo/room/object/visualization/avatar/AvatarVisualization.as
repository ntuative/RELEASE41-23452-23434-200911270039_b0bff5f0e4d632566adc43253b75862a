package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1354:int = 0;
      
      private var var_500:String;
      
      private var var_582:int = 0;
      
      private const const_1547:int = 1;
      
      private var _assetLibrary:AssetLibrary = null;
      
      private var var_1112:Number;
      ...
      private const const_1036:int = 3;
      
      private const const_1546:int = 2;
      
      private var var_749:AvatarVisualizationData = null;
      
      private const const_1035:int = 3;
      ...
      {
         var_749 = param1 as AvatarVisualizationData;
         createSprites(const_1035);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc5_:* = var_411.getValue(_loc4_) as IAvatarImage;
         var _loc6_:String = _loc3_.getString(RoomObjectVariableEnum.const_165);
         var _loc7_:Number = new Date().valueOf();
         var _loc8_:Boolean = false;
         var _loc9_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_607);
         var _loc10_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_533);
         ...
         var _loc13_:Number = _loc7_ - var_1112;
         ...
         var _loc15_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_298);
         if(_loc15_ > 0)
         {
         ...
         var _loc19_:Boolean = var_273 != _loc2_.getUpdateID() || var_207 != param1.scale || var_182 != _loc3_.getUpdateID();
         var _loc20_:Boolean = _isAnimating || var_449 > 0;
         if(_loc19_ || _loc20_)
         {
            --var_449;
            _loc22_ = getTimer();
            if(var_500 != _loc6_)
            {
               for each(_loc48_ in var_411.getKeys())
               {
                  var_411.remove(_loc48_);
               }
               _loc5_ = null;
            }
            if(_loc5_ == null)
            {
               _loc5_ = var_749.getAvatar(_loc6_,param1.scale);
               if(_loc5_ == null)
               {
                  return;
               }
               var_411.remove(_loc4_);
               var_411.add(_loc4_,_loc5_);
               var_500 = _loc6_;
            }
            ...
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_285);
            if(isNaN(_loc24_) || _loc3_.getString(RoomObjectVariableEnum.const_255) == "float")
            {
               _loc24_ = _loc23_;
            }
            else
            ...
            _loc5_.setDirectionAngle(AvatarSetType.const_44,_loc24_);
            _loc5_.initActionAppends();
            _loc25_ = _loc3_.getString(RoomObjectVariableEnum.const_255);
            _loc26_ = _loc3_.getString(RoomObjectVariableEnum.const_634);
            _loc5_.appendAction(AvatarAction.const_719,_loc25_,_loc26_);
            _loc27_ = false;
            if(_loc25_ == "lay")
            {
            ...
            if(_loc28_ > 0 && _loc5_.getScale() == AvatarScaleType.const_50)
            {
               ...
               {
                  _loc5_.appendAction(AvatarAction.const_309,AvatarAction.const_1271[_loc28_]);
               }
            }
            _loc29_ = _loc3_.getNumber(RoomObjectVariableEnum.const_956);
            if(_loc29_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_820,_loc29_);
            }
            _loc30_ = _loc3_.getNumber(RoomObjectVariableEnum.const_924);
            if(_loc30_ > 0)
            {
               _loc53_ = _loc3_.getNumber(RoomObjectVariableEnum.const_779);
               _loc54_ = 5;
               _loc55_ = _loc7_ - _loc53_;
               if(_loc55_ < _loc54_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_845,_loc30_);
               }
            }
            _loc31_ = _loc3_.getNumber(RoomObjectVariableEnum.const_529);
            _loc32_ = 0;
            if(_loc31_ > 0)
            {
               _loc56_ = _loc3_.getNumber(RoomObjectVariableEnum.const_560);
               _loc57_ = 100;
               _loc58_ = _loc7_ - _loc56_;
               if(_loc58_ < _loc57_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_868,_loc31_);
                  _loc59_ = 1;
                  while(_loc59_ < 10)
                  {
            ...
            _loc33_ = _loc3_.getNumber(RoomObjectVariableEnum.const_812);
            if(_loc32_ > 0)
            {
               _loc33_ = _loc32_;
            }
            if(_loc33_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_912,_loc33_);
            }
            if(_loc8_)
            {
               _loc5_.appendAction(AvatarAction.const_376);
            }
            _loc34_ = _loc3_.getNumber(RoomObjectVariableEnum.const_371) > 0;
            if(_loc34_ || _loc12_)
            {
               _loc5_.appendAction(AvatarAction.const_587);
            }
            if(_loc14_)
            {
               _loc5_.appendAction(AvatarAction.const_395);
            }
            _loc35_ = _loc3_.getNumber(RoomObjectVariableEnum.const_831);
            if(_loc35_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_553,_loc35_);
            }
            ...
            _loc42_ = getSprite(const_1546);
            if(_loc3_.getNumber(RoomObjectVariableEnum.const_878))
            {
               _loc42_.visible = true;
               _loc39_ = null;
               _loc38_ = null;
               ...
               if(_loc38_ != null)
               {
                  _loc39_ = var_749.getAvatarRendererAsset(_loc38_) as BitmapDataAsset;
               }
               if(_loc39_ != null)
               {
                  _loc42_.asset = _loc39_;
            ...
            var_273 = _loc2_.getUpdateID();
            var_182 = _loc3_.getUpdateID();
            var_207 = param1.scale;
            var_750.push(getTimer() - _loc22_);
            if(false)
            {
               _loc76_ = 0;
               _loc77_ = "[";
               for each(_loc78_ in var_750)
               {
                  _loc76_ += _loc78_;
                  _loc77_ += "," + _loc78_;
               }
