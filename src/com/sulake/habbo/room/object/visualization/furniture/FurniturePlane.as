   ...
   public class FurniturePlane
   {
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_2113)
         {
            if(!param1)
            {
               var_244.assign(var_570);
               var_245.assign(var_571);
            }
            else
            {
               var_244.assign(var_570);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_80 == null && var_586 != null || var_244 == null || var_245 == null || var_360 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1275)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_1023 || _loc4_.y != var_1561 || _loc4_.z != var_1555 || param1.scale != var_1557))
            {
               ...
               _loc6_ = param1.getScreenPosition(var_586);
               _loc7_ = _loc6_.z;
