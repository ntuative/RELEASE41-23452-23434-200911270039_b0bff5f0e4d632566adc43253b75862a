package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_2146:Number = NaN;
            ...
            if(_loc6_ != null)
            {
               ...
               if(_loc7_ != null)
               {
                  ...
                  if(_loc4_ < spriteCount - 1)
                  {
                     ...
                     _loc6_.color = getSpriteColor(_loc4_,var_2150,param1);
                  ...
                  else
                  {
                     ...
                     {
                        _loc9_ *= object.getModel().getNumber(RoomObjectVariableEnum.const_166);
                     }
                     _loc6_.alpha = _loc9_;
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2150 = _loc3_.getNumber(RoomObjectVariableEnum.const_210);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_273 != _loc3_.getUpdateID() || param1 != var_207 || param2 != var_2146)
         {
            _loc4_ = _loc3_.getDirection().x - (param2 + 135);
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = _data.getDirectionValue(_loc4_,param1);
            _direction = _loc5_;
            var_273 = _loc3_.getUpdateID();
            var_2146 = param2;
            return true;
         }
         return false;
