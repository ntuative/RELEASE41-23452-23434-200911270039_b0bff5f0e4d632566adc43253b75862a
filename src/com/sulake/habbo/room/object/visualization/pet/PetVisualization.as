package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_749:PetVisualizationData = null;
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc9_:* = 0;
         var _loc11_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_888);
         if(_loc11_ > 0)
         {
            _loc16_ = getTimer() - _loc11_;
            if(_loc16_ < AvatarAction.const_958)
            {
               _loc9_ = uint(int(Math.sin(Number(_loc16_) / 0 * 0) * 255));
               _loc10_ = _loc3_.getNumber(RoomObjectVariableEnum.const_934);
               var_449 = const_1036;
            }
         }
         var _loc12_:Boolean = false;
         var _loc13_:String = _loc3_.getString(RoomObjectVariableEnum.const_255);
         switch(_loc13_)
         {
         ...
         var _loc14_:Boolean = var_273 != _loc2_.getUpdateID() || var_207 != param1.scale || var_182 != _loc3_.getUpdateID();
         var _loc15_:Boolean = _isAnimating || var_449 > 0 || _loc12_;
         if(_loc14_ || _loc15_)
         {
            _loc17_ = getTimer();
            --var_449;
            if(var_500 != _loc6_)
            {
               for each(_loc35_ in var_411.getKeys())
               {
                  var_411.remove(_loc35_);
               }
               _loc5_ = null;
            }
            if(_loc5_ == null)
            ...
            _loc19_ = _loc3_.getNumber(RoomObjectVariableEnum.const_285);
            if(isNaN(_loc19_))
            {
               _loc19_ = _loc18_;
            }
            ...
            _loc5_.setDirectionAngle(AvatarSetType.const_44,_loc19_);
            _loc5_.initActionAppends();
            _loc20_ = _loc3_.getString(RoomObjectVariableEnum.const_255);
            _loc21_ = _loc3_.getString(RoomObjectVariableEnum.const_634);
            _loc5_.appendAction(AvatarAction.const_719,_loc20_,_loc21_);
            _loc22_ = false;
            if(_loc20_ == "lay")
            {
            ...
            if(_loc23_ != null && _loc23_ != "")
            {
               ...
               {
                  _loc5_.appendAction(AvatarAction.const_309,_loc23_);
               }
            }
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_371) > 0;
            if(_loc24_)
            {
            ...
            _loc29_ = _loc5_.getSprites().length + const_1035;
            ...
            _loc30_ = getSprite(const_1546);
            if(_loc9_ > 0)
            {
               _loc28_ = null;
               _loc28_ = var_749.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
               if(_loc28_ != null)
               {
            ...
            var_750.push(getTimer() - _loc17_);
            if(false)
            {
               _loc55_ = 0;
               _loc56_ = "[";
               for each(_loc57_ in var_750)
               {
                  _loc55_ += _loc57_;
                  _loc56_ += "," + _loc57_;
               }
      ...
      {
         var_749 = param1 as PetVisualizationData;
         createSprites(4);
         return true;
      }
