package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1110:int = 13421772;
      
      private static const const_1038:int = 16777215;
      
      public static const const_1135:int = 10066329;
      
      private static const const_1040:int = 13421772;
      
      public static const const_1177:int = 16777215;
      
      private static const const_1355:int = 0;
      
      public static const const_1131:int = 16777215;
      
      private static const const_1039:int = 10066329;
      
      private static const const_1037:int = 10066329;
      
      public static const const_1183:int = 13421772;
      ...
      protected function updatePlanes(param1:IRoomGeometry) : void
      {
         ...
         while(_loc4_ < var_108.length)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc5_)
               {
                  _loc9_.assetName = _loc6_ + "_" + var_1328;
               }
               if(var_84.getPlaneType(_loc4_) == RoomPlaneData.const_143)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < var_84.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_231)
            {
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_257 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         if(var_182 != _loc3_.getUpdateID())
         {
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_492);
            _loc6_ = _loc3_.getString(RoomObjectVariableEnum.const_601);
            _loc7_ = _loc3_.getString(RoomObjectVariableEnum.const_580);
            updatePlaneTextureTypes(_loc6_,_loc5_,_loc7_);
            _loc8_ = _loc3_.getString(RoomObjectVariableEnum.const_851);
            if(_loc8_ != var_1746)
            {
               updatePlaneMasks(_loc8_);
               var_1746 = _loc8_;
            }
            _loc9_ = uint(_loc3_.getNumber(RoomObjectVariableEnum.const_505));
            if(_loc9_ != var_931)
            {
               var_931 = _loc9_;
            }
            var_1747 = Boolean(_loc3_.getNumber(RoomObjectVariableEnum.const_790));
         ...
         while(_loc4_ < var_108.length)
         {
            ...
            if(_loc10_ != null && _loc11_ != null && _loc11_.type != RoomPlane.const_173)
            {
               ...
               if(var_1747)
               {
                  _loc13_ = uint((_loc12_ & 255) * (var_931 & 255) / 255);
                  _loc14_ = uint((_loc12_ >> 8 & 255) * (var_931 >> 8 & 255) / 255);
                  _loc15_ = uint((_loc12_ >> 16 & 255) * (var_931 >> 16 & 255) / 255);
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_844);
         var _loc7_:int = 0;
         while(_loc7_ < var_84.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_126)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_257,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_231)
            {
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_108.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_257 && param2 != null)
               {
                  _loc5_.id = param2;
               }
         ...
         while(_loc5_ < _planeMaskParser.maskCount)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc9_ < var_108.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_257 || _loc3_.type == RoomPlane.const_173 && _loc8_ == RoomPlaneBitmapMaskData.const_195)
                  {
