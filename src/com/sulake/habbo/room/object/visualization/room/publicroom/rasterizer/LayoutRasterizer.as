package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_881:LayoutRasterizerData = null;
      ...
      private var var_426:Boolean = true;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_882 = param1;
         var _loc3_:LayoutRasterizerData = var_67.getValue(var_588);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1059 = RoomObjectVariableEnum.const_894;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1059 = RoomObjectVariableEnum.const_889;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_882 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_882 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_882 + _adBgIndex);
            _loc5_ = param1.getSprite(var_882 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1059);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_410;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_1565);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_588)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_881 = var_67.getValue(var_588);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_67.getValue(var_588);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_881.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_309.indexOf(_loc10_) >= 0 && var_426)
            {
               param1 = var_309.indexOf(_loc10_);
               if(true)
               {
