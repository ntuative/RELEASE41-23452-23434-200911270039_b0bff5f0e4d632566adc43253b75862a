package com.sulake.habbo.room.object.visualization.room.rasterizer.animated
{
   ...
   public class LandscapeRasterizer extends PlaneRasterizer
   {
      ...
      private static const const_336:int = 500;
      ...
      private function parseLandscapes(param1:XML) : void
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            if(XMLValidator.checkRequiredAttributes(_loc6_,["id"]))
            {
               ...
               if(var_329.getValue(_loc7_) == null)
               {
                  var_329.add(_loc7_,_loc9_);
               }
               else
               {
                  _loc9_.dispose();
      ...
      {
         var _loc13_:LandscapePlane = var_329.getValue(param2);
         if(_loc13_ == null)
         {
            _loc13_ = var_329.getValue(const_721);
         }
         if(_loc13_ == null)
         {
            return null;
         ...
         var _loc15_:* = null;
         if(!_loc13_.isStatic(param5) && const_336 > 0)
         {
            _loc15_ = new PlaneBitmapData(_loc14_,Math.round(param12 / const_336) * const_336 + const_336);
         }
         else
         {
      ...
      override public function dispose() : void
      {
         ...
         if(var_329 != null)
         {
            ...
            {
               _loc2_ = var_329.getWithIndex(_loc1_) as LandscapePlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
