package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_470:PlaneTexture;
      ...
      public function render(param1:IVector3d) : BitmapData
      {
         ...
         if(var_470 != null)
         {
            _loc2_ = var_470.getBitmap(param1);
            if(_loc2_ != null)
            {
               if(!isStatic)
               {
                  ...
                  _loc3_ = Math.min(var_977,_extraItemOffsets.length);
                  _loc4_ = Math.max(var_977,_extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(var_977,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
