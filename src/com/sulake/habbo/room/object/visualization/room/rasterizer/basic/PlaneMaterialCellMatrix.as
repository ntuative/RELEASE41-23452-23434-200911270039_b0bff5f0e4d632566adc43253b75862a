package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1320:int = const_274;
      ...
      public static const const_693:int = 6;
      
      public static const const_266:int = const_91;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1, param5:Number = 1, param6:Number = -1, param7:Number = 1)
      {
         ...
         var_1884 = param6;
         var_1882 = param7;
         var_801 = new Vector3d();
         if(var_1418 == const_693)
         {
            var_1215 = false;
         }
      }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1451 == const_91)
         {
            _loc5_ = new Rectangle(0,0,var_38.width,var_474);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_474,var_38.width,var_474);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_38 != null)
            {
               if(var_38.width == param2 && var_38.height == param3 && Vector3d.isEqual(var_801,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_474,param6,param7);
                     return param1;
                  }
                  return var_38;
               }
