package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      private var var_2214:int = 69069;
      
      private var var_1192:int = 1;
      
      private var var_2215:int = 5;
      
      private var var_1421:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1421 * param2);
      }
      ...
      {
         var _loc1_:int = var_2214 * var_1192 + var_2215;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
