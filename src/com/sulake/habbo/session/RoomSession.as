package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1000:UserDataManager;
      ...
      {
         if(_state == RoomSessionEvent.const_289 && _connection != null)
         {
            _state = RoomSessionEvent.const_82;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1000 as IUserDataManager;
      }
