package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         var_780 = true;
         if(var_198.getValue(_loc6_) != null)
         {
      ...
      private function initializeManager() : void
      {
         ...
         if(initialized && var_1153)
         {
            gotoRoom(var_1843,var_1845,var_1152);
            var_1153 = false;
            var_1152 = "";
         }
      }
      ...
      public function startSession(param1:IRoomSession) : Boolean
      {
         ...
         {
            var_780 = false;
            _events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_82,param1));
      ...
      override public function dispose() : void
      {
         ...
         if(var_198)
         {
            while(false)
            {
               _loc1_ = var_198.getKey(0) as String;
               _loc2_ = var_198.remove(_loc1_) as RoomSession;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function getSession(param1:int, param2:int) : IRoomSession
      {
         ...
         return var_198.getValue(_loc3_) as IRoomSession;
      }
      ...
      public function sessionReinitialize(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc6_:RoomSession = var_198.remove(_loc5_) as RoomSession;
         if(_loc6_ != null)
         {
            param4 = param2;
            _loc6_.reset(param3,param4);
            _loc5_ = getRoomIdentifier(param3,param4);
            _loc7_ = var_198.remove(_loc5_);
            if(_loc7_ != null)
            {
            }
            var_198.add(_loc5_,_loc6_);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomSession = var_198.remove(_loc3_) as RoomSession;
         if(_loc4_ != null)
         {
