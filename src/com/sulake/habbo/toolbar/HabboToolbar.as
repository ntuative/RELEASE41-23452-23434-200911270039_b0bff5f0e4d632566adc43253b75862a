package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_593.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_765,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_158,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_152,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_45,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_346,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_650,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_791,onHideWindowEvent);
         _state = true;
