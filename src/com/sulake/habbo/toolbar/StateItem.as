package com.sulake.habbo.toolbar
{
   public class StateItem
   {
      ...
      private var var_1127:String = "-1";
      
      private var var_1126:String;
      
      private var var_1759:Boolean;
      
      private var var_1359:String = "-1";
      ...
      public function StateItem(param1:XML, param2:String)
      {
         ...
         {
            var_1230 = Boolean(param1.@loop);
         }
         if(param1.attribute("bounce").length() > 0)
         {
            var_1759 = Boolean(param1.@loop);
         }
         ...
         {
            var_1359 = param1.@state_default;
         }
         if(param1.attribute("tooltip").length() > 0)
         {
            var_1760 = param1.@tooltip;
         }
