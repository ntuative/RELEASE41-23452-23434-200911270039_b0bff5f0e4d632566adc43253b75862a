package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1030:Number = 90;
      
      private static const const_727:int = 50;
      
      private static const const_1015:Number = 25;
      
      private static const const_1016:int = 50;
      
      private static const const_172:Boolean = true;
       
      
      private var var_511:Timer;
      
      private var var_891:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_891 = param2;
         var_511 = new Timer(const_1015);
         var_511.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_439.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_439.splice(_loc3_,1);
            var_440.splice(_loc3_,1);
         }
         var_440.push(param1.name);
         var_439.push(param2);
         param1.addEventListener(WindowEvent.const_432,windowEventListener);
         param1.addEventListener(WindowEvent.const_218,windowEventListener);
      }
      
      private function method_13(param1:String) : String
      {
         return var_439[var_440.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_891.method_3(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function method_1(param1:String) : void
      {
         if(var_277.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_277.splice(var_277.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_891.getIconLoc(param1.iconId);
      ...
      {
         return var_440[var_439.indexOf(param1)];
      }
      ...
      {
         var _loc1_:int = 0;
         while(_loc1_ < var_277.length)
         {
            repositionWindow(var_277[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_512[_loc3_] = new Array();
            }
            if(var_512[_loc3_].indexOf(param1) < 0)
            {
               var_512[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_727 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_727 || param1.desktop.height - param1.y < const_1016;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_440[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_512[_loc3_].length)
                  {
                     repositionWindow(var_512[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
