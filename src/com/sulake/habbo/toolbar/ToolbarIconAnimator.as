   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_825.push(new XML());
               var_827.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_827[var_58] = param6.clone();
         }
      ...
      {
         if(var_1230 == true || var_671 == 0)
         {
            if(false)
            {
               ++var_58;
               if(var_58 >= var_825.length)
               {
                  var_58 = 0;
                  ++var_671;
               }
      ...
      {
         return var_825.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1230 == false && var_671 == 1 && var_1127 != _state;
      }
      ...
      {
         var _loc2_:* = null;
         if(var_58 <= var_827.length)
         {
            _loc2_ = var_827[var_58];
