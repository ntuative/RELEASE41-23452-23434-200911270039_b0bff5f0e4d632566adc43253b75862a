package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_407:ToolbarBarMenuAnimator;
      ...
      {
         return var_1207.indexOf(param1) > -1;
      }
      ...
      public function method_3(param1:String) : ToolbarIcon
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         while(_loc3_ < var_294.length)
         {
            _loc2_ = var_294[_loc3_];
            if(_loc2_ != null)
            {
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1208.length)
         {
            _loc2_ = var_656.indexOf(var_1208[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_294[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(var_770 + _loc3_);
                  _loc3_ += var_1206;
               }
            }
            _loc4_++;
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,_windowManager,_assetLibrary,param1,_events,var_407);
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = var_656.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = getIconById(param1);
            if(_loc3_ != null)
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_294[var_656.indexOf(param1)];
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = var_1970.elements("menu");
         var _loc5_:int = 0;
