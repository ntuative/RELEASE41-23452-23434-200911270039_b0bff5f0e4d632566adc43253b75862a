package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_463:String = "LEFT";
      
      private var var_200:IWindowContainer;
      
      private var var_539:Array;
      
      private var var_1414:Number = 15;
      
      private var _events:IEventDispatcher;
      
      private var var_342:ToolbarBarMenuAnimator;
      
      private var var_1413:Number = 5;
      
      private var var_256:Array;
      
      private var var_136:Number = 50;
      
      private var var_1179:Number = 0;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_136 = _window.width;
         var_200 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_53,HabboWindowStyle.const_834,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_964 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_964)
         {
         ...
         var_1179 = _loc7_.toolbar.@margin_bottom;
         var_1414 = _loc7_.toolbar.@min_group_margin;
         var_1413 = _loc7_.toolbar.@margin_to_extrabar;
         var_342 = new ToolbarBarMenuAnimator(param1,this);
         var _loc8_:XMLList = XMLList(_loc7_.toolbar).children();
         var _loc9_:XMLList = XMLList(_loc7_.extras).children();
         createGroupsFromXmlList(_loc8_,var_256,param1,param2,_window,var_342);
         createGroupsFromXmlList(_loc9_,var_539,param1,param2,var_200,var_342);
         alignWindows();
      }
      ...
      {
         var _loc3_:ToolbarIconGroup = method_4(param1);
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:ToolbarIconGroup = method_4(param1);
         if(_loc2_ != null)
         {
      ...
      public function method_3(param1:String) : ToolbarIcon
      {
         var _loc2_:ToolbarIconGroup = method_4(param1);
         if(_loc2_ != null)
         {
            return _loc2_.method_3(param1);
         }
         return null;
      }
      ...
      {
         var _loc4_:ToolbarIcon = method_3(param1);
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_136,var_463,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         {
            case "LEFT":
               _window.width = var_136;
               _window.height = _loc1_.height;
               _window.x = 0;
               _window.y = 0;
               var_200.x = var_136 + var_1413;
               var_200.y = 0;
               _loc4_ = 0;
               break;
            case "RIGHT":
               _window.width = var_136;
               _window.height = _loc1_.height;
               _window.x = _loc1_.width - var_136;
               _window.y = 0;
               var_200.x = 0;
               var_200.y = 0;
               _loc4_ = 0;
            ...
            case "TOP":
               ...
               _window.height = var_136;
               _window.x = 0;
               _window.y = 0;
               var_200.x = 0;
               var_200.y = var_136 + var_1413;
               _loc4_ = 0;
               break;
            case "BOTTOM":
               _window.width = _loc1_.width;
               _window.height = var_136;
               _window.x = 0;
               _window.y = _loc1_.height - var_136;
               var_200.x = 0;
               var_200.y = 0;
               _loc4_ = 0;
         }
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1414,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1179) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1414,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1179) / -1));
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_ = new ToolbarIconGroup(param3,param4,_loc10_,_events,param5,param6,var_136);
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - var_136)
         {
            return "RIGHT";
         }
         if(param2 <= var_136)
         ...
         if(param2 >= _loc3_.height - var_136)
         {
            return "BOTTOM";
         }
         return null;
      ...
      {
         alignWindows();
         var _loc3_:ToolbarIcon = method_3(param1);
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_136,var_463);
         }
      }
      ...
      private function method_4(param1:String) : ToolbarIconGroup
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         _loc3_ = 0;
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_463);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_136,var_463);
         }
      }
