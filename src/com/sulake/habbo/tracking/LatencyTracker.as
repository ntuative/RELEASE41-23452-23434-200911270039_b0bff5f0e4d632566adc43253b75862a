package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      {
         var_1318 = getTimer();
         var_431.add(var_1070,var_1318);
         _connection.send(new LatencyPingRequestMessageComposer(var_1070));
         ++var_1070;
      }
      ...
      public function init() : void
      {
         ...
         var_1319 = int(var_176.getKey("latencytest.interval"));
         var_1320 = int(var_176.getKey("latencytest.report.index"));
         var_1620 = int(var_176.getKey("latencytest.report.delta"));
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(var_431 == null || var_152 == null)
         {
            return;
         }
         var _loc2_:LatencyPingResponseMessageParser = (param1 as LatencyPingResponseMessageEvent).getParser();
         var _loc3_:int = var_431.getValue(_loc2_.requestId);
         var_431.remove(_loc2_.requestId);
         var _loc4_:int = getTimer() - _loc3_;
         var_152.push(_loc4_);
         if(var_152.length == var_1320 && var_1320 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - var_1317) > var_1620 || var_1317 == 0)
            {
               var_1317 = _loc9_;
