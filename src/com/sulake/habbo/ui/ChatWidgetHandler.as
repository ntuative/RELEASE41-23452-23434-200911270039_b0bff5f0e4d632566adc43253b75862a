package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_478:Point = null;
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc12_ = uint(var_667.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_287:
      ...
      {
         return [RoomWidgetChatMessage.const_526,RoomWidgetChatSelectAvatarMessage.const_676];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_526:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_139,_container.roomSession,0,"Version 23452-23434-200911270013");
                           ...
                           case ":chooser":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_276);
                           ...
                           case ":furni":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_380);
                                 _container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_676:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_822 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_822);
            }
            if(var_478 == null)
            {
               var_479.x = 0;
               var_479.y = 0;
               var_479.z = 0;
               var_478 = _loc4_.getScreenPoint(var_479);
               var_822 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_479.x = 0;
            var_479.y = 0;
            var_479.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_479);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_478.x || _loc8_.y != var_478.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_478,_loc5_));
