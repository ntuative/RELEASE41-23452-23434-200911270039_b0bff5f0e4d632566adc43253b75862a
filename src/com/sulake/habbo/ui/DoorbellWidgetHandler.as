package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_94;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_94:
               _loc2_ = param1 as RoomSessionDoorbellEvent;
               if(_loc2_ == null)
               {
                  return;
               }
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_585,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_564];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_564:
      ...
      {
         return [RoomSessionDoorbellEvent.const_94,RoomSessionDoorbellEvent.const_103];
      }
