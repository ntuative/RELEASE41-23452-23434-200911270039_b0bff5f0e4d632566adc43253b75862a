package com.sulake.habbo.ui
{
   ...
   public class FurnitureDimmerWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomEngineObjectEvent.const_81:
               _container.events.dispatchEvent(new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_935));
         }
      }
      
      public function getWidgetMessages() : Array
      {
         return [RoomWidgetFurniToWidgetMessage.const_516,RoomWidgetDimmerSavePresetMessage.const_688,RoomWidgetDimmerChangeStateMessage.const_524,RoomWidgetDimmerPreviewMessage.const_597];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_516:
               if(validateRights())
               {
            ...
            case RoomWidgetDimmerSavePresetMessage.const_688:
               ...
               break;
            case RoomWidgetDimmerChangeStateMessage.const_524:
               if(validateRights())
               {
                  _container.roomSession.sendRoomDimmerChangeStateMessage();
               }
               break;
            case RoomWidgetDimmerPreviewMessage.const_597:
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(RoomEngineObjectEvent.const_81);
         return _loc1_;
      }
