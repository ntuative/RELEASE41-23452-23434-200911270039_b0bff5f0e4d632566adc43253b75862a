package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_600,RoomWidgetEcotronBoxOpenMessage.const_523,RoomWidgetEcotronBoxOpenedMessage.const_1220];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_600:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_523:
