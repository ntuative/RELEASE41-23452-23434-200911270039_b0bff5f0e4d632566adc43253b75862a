package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               ...
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_111,onBadgeImage);
            }
            if(false)
            {
               ...
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetCommandsUpdateEvent.const_144,onPetCommands);
            }
         }
         _container = param1;
         if(param1 == null)
         ...
         if(false)
         {
            ...
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_111,onBadgeImage);
         }
         if(false)
         {
            ...
            _container.roomSessionManager.events.addEventListener(RoomSessionPetCommandsUpdateEvent.const_144,onPetCommands);
         }
      }
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_35:
               ...
               if(_loc9_.type == RoomObjectTypeEnum.const_287)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc9_.webID);
                  return null;
               }
               if(_loc9_.type == RoomObjectTypeEnum.const_385)
               {
                  _loc10_ = "null";
               ...
               {
                  if(_loc9_.type != RoomObjectTypeEnum.const_940)
                  {
                     return null;
                  }
                  _loc10_ = "null";
               ...
               if(_loc14_ != null)
               {
                  _loc11_.carryItem = _loc14_.getModel().getNumber(RoomObjectVariableEnum.const_529);
               }
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.const_194)
               {
                  _loc11_.realName = _container.sessionDataManager.realName;
               }
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.const_215)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     _loc28_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_680);
                  ...
                  _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1126;
                  if(!_loc23_)
                  {
                  ...
                  if(!_loc24_)
                  {
                     _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_793;
                  }
                  if(!_loc25_)
                  {
                     _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_961;
                  }
               ...
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc12_.push(RoomWidgetUserInfoUpdateEvent.const_1307);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_523.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_50);
            var_523.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_680);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_445);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_228);
         _loc1_.push(RoomWidgetFurniActionMessage.const_506);
         _loc1_.push(RoomWidgetFurniActionMessage.const_586);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_666);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_594);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1145);
         _loc1_.push(RoomWidgetPetCommandMessage.const_636);
         _loc1_.push(RoomWidgetPetCommandMessage.const_558);
      ...
      public function dispose() : void
      {
         ...
         if(var_523 != null)
         {
            _loc1_ = var_523.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_523.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_613:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_771,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_665:
               ...
               break;
            case RoomWidgetUserActionMessage.const_445:
            ...
            case RoomWidgetUserActionMessage.const_459:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_666:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_594:
            ...
            case RoomWidgetUserActionMessage.const_703:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_558:
