   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_204 + " " + _loc6_);
            if(var_204 != null && _loc6_ != null)
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_765,HabboToolbarIconEnum.MEMENU);
               _loc8_.bitmapData = _loc6_;
               var_204.events.dispatchEvent(_loc8_);
            }
         }
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_361:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_405));
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_496,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_361,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_496,onFigureUpdate);
         }
         var_28 = _container.inventory;
         if(var_28 != null)
         {
            (var_28 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_897,onAvatarEffectsChanged);
            (var_28 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_521,onHabboClubSubscriptionChanged);
         }
         var_204 = _container.toolbar;
         if(var_204)
         {
            var_204.events.addEventListener(HabboToolbarEvent.const_77,onHabboToolbarEvent);
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_361,onHelpTutorialEvent);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_705);
         _loc1_.push(RoomWidgetDanceMessage.const_574);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_518);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_689);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_497);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_720);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_514);
         ...
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_880);
         _loc1_.push(RoomWidgetToolbarMessage.const_490);
         _loc1_.push(RoomWidgetToolbarMessage.const_612);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_675);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1108);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_978);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_572);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_713);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_718);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_631);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1100);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_614);
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_710));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_713:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetWaveMessage.const_705:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetDanceMessage.const_574:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_518:
               if(var_28 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_689:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_497:
               if(var_28 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_642:
               ...
               if(var_72 != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_550)
               {
                  var_72.openCatalogPage(CatalogPageName.const_311,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_514:
               ...
               if(var_28 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_954:
                        var_72.openCatalogPage(CatalogPageName.const_1194,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_829:
                        var_28.toggleInventoryPage(InventoryCategory.const_225);
                        break;
            ...
            case RoomWidgetNavigateToRoomMessage.const_880:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_572:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_490:
               _loc5_ = param1 as RoomWidgetToolbarMessage;
               if(var_204)
               {
                  var_204.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_45,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_28 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_612:
               ...
               if(var_204)
               {
                  var_204.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_346,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_675:
               ...
               if(_container)
               {
                  ...
                  if(false && !_loc23_)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_341,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_960));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_341,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1186));
                     }
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_718:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_631:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_614:
