package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_393:
               ...
               {
                  case RoomSessionQueueEvent.const_870:
                     _loc3_ = "null";
                     break;
                  case RoomSessionQueueEvent.const_775:
                     _loc3_ = "null";
               }
               if(_loc3_ == null)
               {
               ...
               if(_loc5_.length > 1)
               {
                  if(_loc4_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_982) != -1)
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_982) + 1;
                     _loc7_ = true;
                  }
                  else
                  {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomQueueMessage.const_534);
         _loc1_.push(RoomWidgetRoomQueueMessage.const_532);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_775);
               break;
            case RoomWidgetRoomQueueMessage.const_534:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_870);
               break;
            case RoomWidgetRoomQueueMessage.const_532:
               if(false)
               {
                  _container.catalog.openCatalogPage(CatalogPageName.const_311,true);
               }
         }
         return null;
      }
      ...
      {
         return [RoomSessionQueueEvent.const_393];
      }
