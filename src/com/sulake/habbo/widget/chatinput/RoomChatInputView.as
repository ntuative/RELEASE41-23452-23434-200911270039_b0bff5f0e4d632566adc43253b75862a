package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1345:int = 5;
      ...
      private static const const_995:int = 40;
      ...
      private var var_365:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_875 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1546 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1548 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_583 = new Timer(1000,1);
         var_583.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_708 = new Timer(5000,1);
         var_708.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_131,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_43,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_227,onInputChanged);
         _window.addEventListener(WindowEvent.const_432,onWindowMoved);
         var_1056 = true;
         var_123 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1547 = _loc2_.width + const_477 + _loc6_.width + const_994;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_995,_loc8_.width) + const_477);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_875 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_123 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_365);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_365);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_423);
