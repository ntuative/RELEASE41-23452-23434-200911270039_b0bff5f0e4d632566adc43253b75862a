package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1363:uint = 0;
      ...
      public function method_1(param1:int, param2:int) : void
      {
         var _loc3_:* = null;
      ...
      {
         var _loc2_:* = null;
         if(_itemList == null || param1 < 0 || param1 > _itemList.numListItems || param1 == var_647)
         {
            return;
         }
         if(var_647 != -1)
         {
            _loc2_ = _itemList.getListItemAt(var_647) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(var_647 % 2) ? uint(const_1363) : uint(const_1362);
            }
         }
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(const_1363) : uint(const_1362);
