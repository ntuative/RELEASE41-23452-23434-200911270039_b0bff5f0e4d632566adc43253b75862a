package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_53,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_1014,const_1013,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         if(var_318 != null)
         {
            var_318.setValue(var_890);
         }
         var_385 = colors.indexOf(_loc2_.color);
         if(var_437 != null)
         {
            var_437.setSelectedColorIndex(var_385);
         }
