   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         for each(_loc2_ in colors)
         {
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_744.width,var_744.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_608.width,var_608.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_608,var_608.rect,new Point(0,0),null,null,true);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         var_744 = BitmapData(_loc3_.content);
         _loc3_ = BitmapDataAsset(param1.getAssetByName("dimmer_color_selected"));
         var_608 = BitmapData(_loc3_.content);
      }
