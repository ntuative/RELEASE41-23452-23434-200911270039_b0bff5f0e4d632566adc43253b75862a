package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      public function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IBitmapWrapperWindow = var_109.getListItemByName("image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:ITextWindow = var_109.getListItemByName("description_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
