package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1554:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1551:String = "level";
      
      private var var_109:IItemListWindow;
      
      private const const_1555:String = "energy";
      
      private var var_1138:Map;
      
      private const const_1552:String = "nutrition";
      
      private var var_65:IItemListWindow;
      
      private const const_1556:uint = 3355443;
      
      private var var_219:IBorderWindow;
      
      private const const_1548:int = 158;
      
      private const const_1550:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_253:PetCommandTool;
      
      private const const_1553:uint = 11184810;
      
      private const const_1549:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_219 != null)
         {
            var_109 = var_219.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      private function updateStateElement(param1:String, param2:int, param3:int) : void
      {
         ...
         var _loc4_:IWindowContainer = var_109.getListItemByName("status_container") as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function set ageText(param1:int) : void
      {
         ...
         var _loc2_:ITextWindow = var_109.getListItemByName("age_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(var_109 == null || var_219 == null || var_65 == null)
         {
            return;
         }
         var_65.width = var_65.scrollableRegion.width;
         var_65.visible = false;
         var_109.height = var_109.scrollableRegion.height;
         var_219.height = NaN;
      ...
      private function openTrainView() : void
      {
         if(var_253 == null)
         {
            var_253 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1138.getValue(var_674) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_253.showWindow(true);
            var_253.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function set name(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = var_109.getListItemByName("name_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = var_109.getListItemByName("image_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set raceText(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = var_109.getListItemByName("race_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1551,param1.level,param1.levelMax);
         updateStateElement(const_1549,param1.experience,param1.experienceMax);
         updateStateElement(const_1555,param1.energy,param1.energyMax);
         updateStateElement(const_1552,param1.nutrition,param1.nutritionMax);
         ...
         if(var_253 && var_253.isVisible() && param1.isOwnPet)
         {
            var_253.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      private function set petRespect(param1:int) : void
      {
         ...
         var _loc2_:IWindowContainer = var_109.getListItemByName("petrespect_container") as IWindowContainer;
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_253.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_445,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1548,const_1550,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1553);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1556);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1554);
         return _loc5_;
      }
