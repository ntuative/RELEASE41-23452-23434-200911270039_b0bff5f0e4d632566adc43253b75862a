package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         var_952 = new TagListRenderer(param1,onTagSelected);
      }
      ...
      {
         var _loc1_:IWindowContainer = var_109.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         var _loc2_:ITextWindow = var_109.getListItemByName("realname_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:IWindowContainer = var_109.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         var _loc2_:ITextWindow = var_109.getListItemByName("motto_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_109.getListItemByName("motto_spacer") as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = var_109.getListItemByName("tags_container") as IWindowContainer;
         var _loc4_:IWindowContainer = var_109.getListItemByName("tags_spacer") as IWindowContainer;
         ...
         if(param1.length != 0)
         {
            _loc3_.height = var_952.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      {
         var _loc4_:* = null;
         var _loc2_:ITextWindow = var_109.getListItemByName("handitem_txt") as ITextWindow;
         var _loc3_:IWindowContainer = var_109.getListItemByName("handitem_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_793:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_961:
      ...
      {
         var _loc2_:ITextWindow = var_109.getListItemByName("xp_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_109.getListItemByName("xp_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc3_:IWindowContainer = var_109.getListItemByName("image_and_badges_container") as IWindowContainer;
