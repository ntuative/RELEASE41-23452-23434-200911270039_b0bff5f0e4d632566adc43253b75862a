   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_815 = _window.findChildByName("effect_hilite");
            var_815.visible = false;
         }
         var_813 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_814 = _window.findChildByName("loader_bar");
         if(var_814 != null)
         {
            var_365 = var_814.width;
            var_175.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_813 != null)
         {
            var_813.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_813.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
