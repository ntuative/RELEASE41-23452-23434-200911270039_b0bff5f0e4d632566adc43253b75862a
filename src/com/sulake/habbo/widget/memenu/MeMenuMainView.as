package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function setIconAssets(param1:String, param2:String, param3:String = null, param4:String = null) : void
      {
         ...
         if(param3 != null)
         {
            var_142[param1][0] = param3;
         }
         if(param4 != null)
         {
            var_142[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _window.name = param1;
         for(_loc3_ in var_142)
         {
            _loc6_ = var_142[_loc3_];
      ...
      public function init(param1:MeMenuWidget, param2:String) : void
      {
         ...
         var_142["rooms_icon"] = ["gohome_white","gohome_color"];
         var_142["dance_icon"] = ["dance_white","dance_color"];
         var_142["clothes_icon"] = ["clothes_white","clothes_color"];
         var_142["effects_icon"] = ["effects_white","effects_color"];
         var_142["badges_icon"] = ["badges_white","badges_color"];
         var_142["wave_icon"] = ["wave_white","wave_color"];
         var_142["hc_icon"] = ["_white","_color"];
         var_142["settings_icon"] = ["settings_white","settings_color"];
         _widget = param1;
         createWindow(param2);
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_927);
               break;
            case "wave":
               if(false)
               {
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_546);
               break;
            case "rooms":
            ...
            case "badges":
               ...
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_264);
               break;
            case "hc":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_550));
               _widget.hide();
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_679);
               break;
            default:
