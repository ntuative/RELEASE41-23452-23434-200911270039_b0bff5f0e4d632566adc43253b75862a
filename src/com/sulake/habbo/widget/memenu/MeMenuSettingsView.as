package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      private var var_1463:BitmapData;
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_614);
         }
         else
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_631));
      }
      ...
      private function onButtonOut(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "sounds_off":
               if(var_665 != 0)
               {
                  setBitmapWrapperContent("sounds_off_icon",var_1461);
               }
               break;
            case "sounds_on":
               if(var_665 != 1)
               {
                  setBitmapWrapperContent("sounds_on_icon",var_1460);
               }
         }
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_off_icon",var_1462);
         }
         else
         {
            setBitmapWrapperContent("sounds_off_icon",var_1461);
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_on_icon",var_1463);
         }
         else
         {
            setBitmapWrapperContent("sounds_on_icon",var_1460);
