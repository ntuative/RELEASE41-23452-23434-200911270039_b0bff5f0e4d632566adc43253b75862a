package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_739:int = 150;
      
      private static const const_740:int = 250;
      ...
      private var var_1804:BitmapData;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_41 = param3;
         var_1802 = (_assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         var_1378 = (_assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         var_1804 = (_assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         var_1376 = (_assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         var_1377 = (_assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         var_1799 = (_assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         var_1800 = (_assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         var_77 = _windowManager.createWindow("chat_history_bg","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_39,HabboWindowParam.const_67,new Rectangle(0,0,param3.width,param3.height - const_70),null,0,0) as IBitmapWrapperWindow;
         var_41.addChild(var_77);
         _window = _windowManager.createWindow("chat_pulldown","",HabboWindowType.const_53,HabboWindowStyle.const_39,HabboWindowParam.const_34,new Rectangle(0,0 - const_70,param3.width,const_70),null,0) as IWindowContainer;
         var_41.addChild(_window);
         var_103 = _windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_408,HabboWindowStyle.const_40,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_70),null,0) as IRegionWindow;
         if(var_103 != null)
         {
            var_103.background = true;
            var_103.alphaTreshold = 0;
            var_103.addEventListener(WindowMouseEvent.const_55,onPulldownMouseDown);
            var_41.addChild(var_103);
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_452:
               var_77.blend += param1 / const_740;
               _window.blend += param1 / const_740;
               if(false)
               {
                  state = const_310;
               }
               break;
            case const_758:
               var_77.blend = 0 - param1 / const_739;
               _window.blend = 0 - param1 / const_739;
               if(true)
               {
                  state = const_203;
               }
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            var_103.x = 0;
            var_103.y = 0 - const_70;
            var_103.width = 0 - var_1803;
         }
         if(var_77 != null)
         {
            var_77.rectangle = var_41.rectangle;
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(var_1801 == _window.width)
         {
            return;
         }
         var_1801 = _window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               tileBitmapHorz(var_1802.clone(),_loc7_);
               _loc1_.bitmap = _loc7_;
            }
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               _loc8_ = new BitmapData(_loc3_.width,_loc3_.height);
               tileBitmapHorz(var_1378.clone(),_loc8_);
               _loc3_.bitmap = _loc8_;
            }
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               _loc9_ = new BitmapData(_loc4_.width,_loc4_.height);
               tileBitmapHorz(var_1378.clone(),_loc9_);
