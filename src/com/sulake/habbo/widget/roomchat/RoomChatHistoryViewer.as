package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_162.state = RoomChatHistoryPulldown.const_203;
         ...
         var_50 = param2.createWindow("chatscroller","",HabboWindowType.const_948,HabboWindowStyle.const_40,0 | 0,new Rectangle(param3.rectangle.right - const_485,param3.y,const_485,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      {
         return !!var_299 ? Number(const_485) : Number(0);
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_236 > 0 && param2)
         {
            if(var_1258)
            {
               if(Math.abs(param1 - var_236) <= const_784)
               {
                  return;
               }
               var_1258 = false;
            ...
            if(var_299)
            {
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(var_50.scrollV < 1 - const_1091 / var_50.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1487)
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_162.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_203);
      }
