package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1032:Number = 18;
      
      private static const const_1353:Number = 10;
      
      private static const const_1352:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_914,var_913,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_914,var_913,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1106 = param1.chatType;
         var_914 = param1.userId;
         var_746 = param1.userName;
         var_913 = param1.userCategory;
         _message = param1.text;
         var_1107 = param1.userX;
         var_193 = param1.userImage;
         var_912 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1106)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_234:
               ...
               _loc2_ = true;
               break;
            case RoomWidgetChatUpdateEvent.const_260:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
         }
         ...
         if(var_193 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_373 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_912 != 0)
            {
               _loc31_ = uint(var_912 >> 16 & 255);
               _loc32_ = uint(var_912 >> 8 & 255);
               _loc33_ = uint(var_912 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1106 == RoomWidgetChatUpdateEvent.const_234)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_746);
            }
            else if(var_1106 == RoomWidgetChatUpdateEvent.const_260)
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_333 + _loc20_.textWidth + const_477;
            _loc38_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_914,var_913,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_914,var_913,_roomId,_roomCategory,param1);
      }
