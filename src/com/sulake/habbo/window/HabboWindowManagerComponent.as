package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, ICoreUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1064:uint = 1;
      ...
      private var var_1146:ProfilerAgentTask;
      
      private var var_1143:IEventDispatcher;
      
      private var var_2240:uint = 0;
      
      private var var_1144:ProfilerAgentTask;
      
      private var var_1145:ProfilerOutput;
      
      private var var_628:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         {
            var_199 = CoreComponent(param1).root.stage;
            _instance = this;
            var_1143 = Component(param1).events;
            var_772 = new Array();
      ...
      {
         return var_284[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_284[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_628 = new WindowRenderer(_loc4_);
         var_284 = new Array(const_335);
         var _loc6_:int = 0;
         while(_loc6_ < const_335)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_628,this,_localization,var_199,new Rectangle(0,0,var_199.stageWidth,var_199.stageHeight),this);
            var_284[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_406 = var_284[const_1064];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_406.getMouseCursor().defineCustomCursorType(MouseCursorType.const_292,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_406.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1196,_loc7_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_284[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_284.pop()).dispose();
            }
            if(var_1145 != null)
            {
               var_1145.dispose();
      ...
      {
         return var_284[param1].getDesktopWindow().getChildAt(var_406.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1145 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1145 = new ProfilerOutput(_loc3_,this,var_628);
               var_1146 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1146);
      ...
      {
         return var_406.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_856.length > 0)
         {
            var_1143.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_335 - 1;
            while(_loc2_ >= 0)
            {
               var_284[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_937)
         ...
         var_1143.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_335)
         {
            var_284[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_937)
         {
         ...
         if(WindowContext.var_856.length > 0)
         {
            WindowContext.var_856.flush();
         }
         if(WindowContext.var_1280.length > 0)
         {
            WindowContext.var_1280.flush();
         }
         var_1143.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_772[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_772[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_406.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1285,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1136,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1124,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1290,param2.name + ": " + param2.toString());
            }
         }
      }
   }
