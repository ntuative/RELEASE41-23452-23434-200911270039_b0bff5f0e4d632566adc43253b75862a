package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_738:RoomObjectLocationCache;
      ...
      private var var_1679:Number = -10000000;
      
      private var var_1680:Number = -10000000;
      ...
      private var var_902:IRoomRenderingCanvasMouseListener = null;
      
      private var var_903:Point;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_738 = new RoomObjectLocationCache(_loc6_);
         var_278 = new Map();
      ...
      public function update() : void
      {
         if(var_905 == 0)
         {
            checkMouseHits(var_903.x,var_903.y,MouseEvent.MOUSE_MOVE);
         }
         var_905 = 0;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_56.graphics.beginFill(var_20);
      ...
      {
         var _loc11_:Number = param1 - var_901 / 2;
         var _loc12_:Number = param2 - var_904 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(_loc8_ < var_132.length)
         {
            var_132.splice(_loc8_);
         }
         _loc3_ = getTimer();
         ErrorReportStorage.addDebugData("Canvas rendering split time","Canvas render split: " + (_loc3_ - _loc2_));
         var _loc12_:String = " ";
         ...
         ErrorReportStorage.addDebugData("Canvas sprite count","Sorting sprites" + _loc12_ + var_132.length);
         var_132.sortOn("z",0 | 0);
         ErrorReportStorage.addDebugData("Canvas sprite count","Sorted sprites" + _loc12_ + var_132.length);
         var _loc13_:* = null;
         var _loc14_:int = 0;
         _loc7_ = 0;
         while(_loc7_ < _loc8_)
         {
            _loc13_ = var_132[_loc7_] as SortableSprite;
         ...
         while(_loc1_ < var_278.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_902 != null)
                  {
                     var_902.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1338,geometry);
                  }
                  else
                  {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK || !_loc10_.clickHandling)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1679 || param2 != var_1680)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int) : int
      {
         ...
         var _loc6_:IVector3d = var_738.getScreenLocation(param1,_geometry);
         if(_loc6_ == null)
         {
            return 0;
         }
         ...
         _loc7_ += int(var_901 / 2);
         _loc8_ += int(var_904 / 2);
         var _loc10_:int = 0;
         var _loc11_:* = null;
         var _loc12_:* = null;
         var _loc13_:int = 0;
            ...
            if(_loc12_ != null && _loc12_.visible)
            {
               ...
               if(_loc16_ != null)
               {
                  ...
                  if(_loc18_ != null)
                  {
                     ...
                     if(_loc13_ + _loc18_.width >= 0 && _loc13_ < var_901 && (_loc14_ + _loc18_.height >= 0 && _loc14_ < var_904))
                     {
