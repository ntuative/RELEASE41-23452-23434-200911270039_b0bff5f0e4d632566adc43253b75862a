package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_644:Number = 64;
      
      public static const const_923:Number = 32;
      ...
      private var var_1445:Number = 1;
      
      private var var_2219:Number = 500;
      
      private var var_1444:Number = 1;
      
      private var var_89:Vector3d;
      
      private var var_88:Vector3d;
      
      private var var_2220:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_88 = new Vector3d();
         var_992 = new Vector3d();
         var_1446 = 1;
         var_1444 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1445 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_398 != param1 * var_1445)
         {
            var_398 = param1 * var_1445;
            ++var_85;
         }
      }
      ...
      {
         if(var_396 != param1 * var_1446)
         {
            var_396 = param1 * var_1446;
            ++var_85;
         }
      }
      ...
      {
         if(var_397 != param1 * var_1444)
         {
            var_397 = param1 * var_1444;
            ++var_85;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_395 != null)
         {
            ...
            var_395.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_395.add(_loc3_,_loc4_);
            ++var_85;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_992.assign(_loc22_);
         }
         else
         {
            var_992.assign(_loc17_);
         }
         ++var_85;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_397;
         _loc2_.z *= var_398;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_992);
         if(_loc3_ < var_2220 || _loc3_ > var_2219)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_397;
            _loc2_.z *= var_398;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_992);
         }
      ...
      {
         return new Vector3d(0 * var_396,0 * var_397,0 * var_398);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_395 != null)
         {
            ...
            return var_395.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_396,0 * var_397,0 * var_398);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_88;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_396,param2.y * var_397,param2.z * var_398);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_396,param3.y * var_397,param3.z * var_398);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_396,param4.y * var_397,param4.z * var_398);
