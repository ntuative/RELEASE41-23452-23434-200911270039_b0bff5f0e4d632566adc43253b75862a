package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_438 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_654))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_654,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_96 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_654,"EOF"));
            }
         }
      }
      ...
      {
         if(var_438.parse(param1))
         {
            var_52.push(var_438);
            if(false)
            {
               var_127["null"] = var_438;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1185,var_438));
            var_438 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_52 != null && var_127 != null && param1 < var_52.length)
         {
